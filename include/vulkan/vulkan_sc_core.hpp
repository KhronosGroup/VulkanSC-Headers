...
static constexpr VkFormatFeatureFlagBits VK_FORMAT_FEATURE_SAMPLED_IMAGE_FILTER_CUBIC_BIT_EXT {0x00002000U};
...
static constexpr VkPipelineStageFlagBits VK_PIPELINE_STAGE_NONE {0U};
static constexpr VkPipelineStageFlagBits VK_PIPELINE_STAGE_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR {0x00400000U};
static constexpr VkPipelineStageFlagBits VK_PIPELINE_STAGE_NONE_KHR {VK_PIPELINE_STAGE_NONE};
...
static constexpr VkEventCreateFlagBits VK_EVENT_CREATE_DEVICE_ONLY_BIT {0x00000001U};
static constexpr VkEventCreateFlagBits VK_EVENT_CREATE_DEVICE_ONLY_BIT_KHR {VK_EVENT_CREATE_DEVICE_ONLY_BIT};
...
static constexpr VkPipelineCacheCreateFlagBits VK_PIPELINE_CACHE_CREATE_READ_ONLY_BIT {0x00000002U};
...
static constexpr VkPipelineShaderStageCreateFlagBits VK_PIPELINE_SHADER_STAGE_CREATE_ALLOW_VARYING_SUBGROUP_SIZE_BIT {0x00000001U};
static constexpr VkPipelineShaderStageCreateFlagBits VK_PIPELINE_SHADER_STAGE_CREATE_REQUIRE_FULL_SUBGROUPS_BIT {0x00000002U};
static constexpr VkPipelineShaderStageCreateFlagBits VK_PIPELINE_SHADER_STAGE_CREATE_ALLOW_VARYING_SUBGROUP_SIZE_BIT_EXT {VK_PIPELINE_SHADER_STAGE_CREATE_ALLOW_VARYING_SUBGROUP_SIZE_BIT};
...
static constexpr VkExternalMemoryHandleTypeFlagBits VK_EXTERNAL_MEMORY_HANDLE_TYPE_SCREEN_BUFFER_BIT_QNX {0x00004000U};
...
static constexpr uint32_t VK_MAX_GLOBAL_PRIORITY_SIZE_KHR   {static_cast<uint32_t>(16U)};
...
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_NONE {0ULL};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_TOP_OF_PIPE_BIT {0x00000001ULL};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_DRAW_INDIRECT_BIT {0x00000002ULL};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_VERTEX_INPUT_BIT {0x00000004ULL};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_VERTEX_SHADER_BIT {0x00000008ULL};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_TESSELLATION_CONTROL_SHADER_BIT {0x00000010ULL};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_TESSELLATION_EVALUATION_SHADER_BIT {0x00000020ULL};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_GEOMETRY_SHADER_BIT {0x00000040ULL};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_FRAGMENT_SHADER_BIT {0x00000080ULL};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_EARLY_FRAGMENT_TESTS_BIT {0x00000100ULL};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_LATE_FRAGMENT_TESTS_BIT {0x00000200ULL};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_COLOR_ATTACHMENT_OUTPUT_BIT {0x00000400ULL};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_COMPUTE_SHADER_BIT {0x00000800ULL};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_ALL_TRANSFER_BIT {0x00001000ULL};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_BOTTOM_OF_PIPE_BIT {0x00002000ULL};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_HOST_BIT {0x00004000ULL};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_ALL_GRAPHICS_BIT {0x00008000ULL};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_ALL_COMMANDS_BIT {0x00010000ULL};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_COPY_BIT {0x100000000ULL};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_RESOLVE_BIT {0x200000000ULL};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_BLIT_BIT {0x400000000ULL};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_CLEAR_BIT {0x800000000ULL};
...
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_COMMAND_PREPROCESS_BIT_NV {0x00020000ULL};
...
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_DRAW_INDIRECT_BIT_KHR {VK_PIPELINE_STAGE_2_DRAW_INDIRECT_BIT};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_VERTEX_INPUT_BIT_KHR {VK_PIPELINE_STAGE_2_VERTEX_INPUT_BIT};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_VERTEX_SHADER_BIT_KHR {VK_PIPELINE_STAGE_2_VERTEX_SHADER_BIT};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_TESSELLATION_CONTROL_SHADER_BIT_KHR {VK_PIPELINE_STAGE_2_TESSELLATION_CONTROL_SHADER_BIT};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_TESSELLATION_EVALUATION_SHADER_BIT_KHR {VK_PIPELINE_STAGE_2_TESSELLATION_EVALUATION_SHADER_BIT};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_GEOMETRY_SHADER_BIT_KHR {VK_PIPELINE_STAGE_2_GEOMETRY_SHADER_BIT};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_FRAGMENT_SHADER_BIT_KHR {VK_PIPELINE_STAGE_2_FRAGMENT_SHADER_BIT};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_EARLY_FRAGMENT_TESTS_BIT_KHR {VK_PIPELINE_STAGE_2_EARLY_FRAGMENT_TESTS_BIT};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_LATE_FRAGMENT_TESTS_BIT_KHR {VK_PIPELINE_STAGE_2_LATE_FRAGMENT_TESTS_BIT};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_COLOR_ATTACHMENT_OUTPUT_BIT_KHR {VK_PIPELINE_STAGE_2_COLOR_ATTACHMENT_OUTPUT_BIT};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_COMPUTE_SHADER_BIT_KHR {VK_PIPELINE_STAGE_2_COMPUTE_SHADER_BIT};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_ALL_TRANSFER_BIT_KHR {VK_PIPELINE_STAGE_2_ALL_TRANSFER_BIT};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_TRANSFER_BIT {VK_PIPELINE_STAGE_2_ALL_TRANSFER_BIT_KHR};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_TRANSFER_BIT_KHR {VK_PIPELINE_STAGE_2_ALL_TRANSFER_BIT};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_BOTTOM_OF_PIPE_BIT_KHR {VK_PIPELINE_STAGE_2_BOTTOM_OF_PIPE_BIT};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_HOST_BIT_KHR {VK_PIPELINE_STAGE_2_HOST_BIT};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_ALL_GRAPHICS_BIT_KHR {VK_PIPELINE_STAGE_2_ALL_GRAPHICS_BIT};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_ALL_COMMANDS_BIT_KHR {VK_PIPELINE_STAGE_2_ALL_COMMANDS_BIT};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_COPY_BIT_KHR {VK_PIPELINE_STAGE_2_COPY_BIT};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_RESOLVE_BIT_KHR {VK_PIPELINE_STAGE_2_RESOLVE_BIT};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_BLIT_BIT_KHR {VK_PIPELINE_STAGE_2_BLIT_BIT};
static constexpr VkPipelineStageFlagBits2 VK_PIPELINE_STAGE_2_CLEAR_BIT_KHR {VK_PIPELINE_STAGE_2_CLEAR_BIT};
...
static constexpr VkAccessFlagBits2 VK_ACCESS_2_NONE {0ULL};
static constexpr VkAccessFlagBits2 VK_ACCESS_2_INDIRECT_COMMAND_READ_BIT {0x00000001ULL};
static constexpr VkAccessFlagBits2 VK_ACCESS_2_INDEX_READ_BIT {0x00000002ULL};
static constexpr VkAccessFlagBits2 VK_ACCESS_2_VERTEX_ATTRIBUTE_READ_BIT {0x00000004ULL};
static constexpr VkAccessFlagBits2 VK_ACCESS_2_UNIFORM_READ_BIT {0x00000008ULL};
static constexpr VkAccessFlagBits2 VK_ACCESS_2_INPUT_ATTACHMENT_READ_BIT {0x00000010ULL};
static constexpr VkAccessFlagBits2 VK_ACCESS_2_SHADER_READ_BIT {0x00000020ULL};
static constexpr VkAccessFlagBits2 VK_ACCESS_2_SHADER_WRITE_BIT {0x00000040ULL};
static constexpr VkAccessFlagBits2 VK_ACCESS_2_COLOR_ATTACHMENT_READ_BIT {0x00000080ULL};
static constexpr VkAccessFlagBits2 VK_ACCESS_2_COLOR_ATTACHMENT_WRITE_BIT {0x00000100ULL};
static constexpr VkAccessFlagBits2 VK_ACCESS_2_DEPTH_STENCIL_ATTACHMENT_READ_BIT {0x00000200ULL};
static constexpr VkAccessFlagBits2 VK_ACCESS_2_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT {0x00000400ULL};
static constexpr VkAccessFlagBits2 VK_ACCESS_2_TRANSFER_READ_BIT {0x00000800ULL};
static constexpr VkAccessFlagBits2 VK_ACCESS_2_TRANSFER_WRITE_BIT {0x00001000ULL};
static constexpr VkAccessFlagBits2 VK_ACCESS_2_HOST_READ_BIT {0x00002000ULL};
static constexpr VkAccessFlagBits2 VK_ACCESS_2_HOST_WRITE_BIT {0x00004000ULL};
static constexpr VkAccessFlagBits2 VK_ACCESS_2_MEMORY_READ_BIT {0x00008000ULL};
static constexpr VkAccessFlagBits2 VK_ACCESS_2_MEMORY_WRITE_BIT {0x00010000ULL};
...
static constexpr VkAccessFlagBits2 VK_ACCESS_2_COMMAND_PREPROCESS_READ_BIT_NV {0x00020000ULL};
static constexpr VkAccessFlagBits2 VK_ACCESS_2_COMMAND_PREPROCESS_WRITE_BIT_NV {0x00040000ULL};
...
static constexpr VkAccessFlagBits2 VK_ACCESS_2_INDEX_READ_BIT_KHR {VK_ACCESS_2_INDEX_READ_BIT};
static constexpr VkAccessFlagBits2 VK_ACCESS_2_VERTEX_ATTRIBUTE_READ_BIT_KHR {VK_ACCESS_2_VERTEX_ATTRIBUTE_READ_BIT};
static constexpr VkAccessFlagBits2 VK_ACCESS_2_UNIFORM_READ_BIT_KHR {VK_ACCESS_2_UNIFORM_READ_BIT};
static constexpr VkAccessFlagBits2 VK_ACCESS_2_INPUT_ATTACHMENT_READ_BIT_KHR {VK_ACCESS_2_INPUT_ATTACHMENT_READ_BIT};
static constexpr VkAccessFlagBits2 VK_ACCESS_2_SHADER_READ_BIT_KHR {VK_ACCESS_2_SHADER_READ_BIT};
static constexpr VkAccessFlagBits2 VK_ACCESS_2_SHADER_WRITE_BIT_KHR {VK_ACCESS_2_SHADER_WRITE_BIT};
static constexpr VkAccessFlagBits2 VK_ACCESS_2_COLOR_ATTACHMENT_READ_BIT_KHR {VK_ACCESS_2_COLOR_ATTACHMENT_READ_BIT};
static constexpr VkAccessFlagBits2 VK_ACCESS_2_COLOR_ATTACHMENT_WRITE_BIT_KHR {VK_ACCESS_2_COLOR_ATTACHMENT_WRITE_BIT};
static constexpr VkAccessFlagBits2 VK_ACCESS_2_DEPTH_STENCIL_ATTACHMENT_READ_BIT_KHR {VK_ACCESS_2_DEPTH_STENCIL_ATTACHMENT_READ_BIT};
static constexpr VkAccessFlagBits2 VK_ACCESS_2_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT_KHR {VK_ACCESS_2_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT};
static constexpr VkAccessFlagBits2 VK_ACCESS_2_TRANSFER_READ_BIT_KHR {VK_ACCESS_2_TRANSFER_READ_BIT};
static constexpr VkAccessFlagBits2 VK_ACCESS_2_TRANSFER_WRITE_BIT_KHR {VK_ACCESS_2_TRANSFER_WRITE_BIT};
static constexpr VkAccessFlagBits2 VK_ACCESS_2_HOST_READ_BIT_KHR {VK_ACCESS_2_HOST_READ_BIT};
static constexpr VkAccessFlagBits2 VK_ACCESS_2_HOST_WRITE_BIT_KHR {VK_ACCESS_2_HOST_WRITE_BIT};
static constexpr VkAccessFlagBits2 VK_ACCESS_2_MEMORY_READ_BIT_KHR {VK_ACCESS_2_MEMORY_READ_BIT};
static constexpr VkAccessFlagBits2 VK_ACCESS_2_MEMORY_WRITE_BIT_KHR {VK_ACCESS_2_MEMORY_WRITE_BIT};
...
static constexpr VkSubmitFlagBits VK_SUBMIT_PROTECTED_BIT {0x00000001U};
static constexpr VkSubmitFlagBits VK_SUBMIT_PROTECTED_BIT_KHR {VK_SUBMIT_PROTECTED_BIT};
...
typedef void (VKAPI_PTR *PFN_vkCmdSetEvent2KHR)(VkCommandBuffer                   commandBuffer, VkEvent                                             event, VkDependencyInfo const *                             pDependencyInfo);
...
VKAPI_ATTR void VKAPI_CALL vkCmdWaitEvents2KHR(
    ...
    uint32_t                                    eventCount,
    VkEvent const*                              pEvents,
    VkDependencyInfo const*                     pDependencyInfos);
...
typedef void (VKAPI_PTR *PFN_vkCmdCopyBuffer2KHR)(VkCommandBuffer commandBuffer, VkCopyBufferInfo2 const * pCopyBufferInfo);
typedef void (VKAPI_PTR *PFN_vkCmdCopyImage2KHR)(VkCommandBuffer commandBuffer, VkCopyImageInfo2 const * pCopyImageInfo);
typedef void (VKAPI_PTR *PFN_vkCmdCopyBufferToImage2KHR)(VkCommandBuffer commandBuffer, VkCopyBufferToImageInfo2 const * pCopyBufferToImageInfo);
typedef void (VKAPI_PTR *PFN_vkCmdCopyImageToBuffer2KHR)(VkCommandBuffer commandBuffer, VkCopyImageToBufferInfo2 const * pCopyImageToBufferInfo);
typedef void (VKAPI_PTR *PFN_vkCmdBlitImage2KHR)(VkCommandBuffer commandBuffer, VkBlitImageInfo2 const * pBlitImageInfo);
typedef void (VKAPI_PTR *PFN_vkCmdResolveImage2KHR)(VkCommandBuffer commandBuffer, VkResolveImageInfo2 const * pResolveImageInfo);
...
VKAPI_ATTR void VKAPI_CALL vkCmdCopyImage2KHR(
    VkCommandBuffer                             commandBuffer,
    VkCopyImageInfo2 const*                     pCopyImageInfo);
...
VKAPI_ATTR void VKAPI_CALL vkCmdCopyImageToBuffer2KHR(
    VkCommandBuffer                             commandBuffer,
    VkCopyImageToBufferInfo2 const*             pCopyImageToBufferInfo);

VKAPI_ATTR void VKAPI_CALL vkCmdBlitImage2KHR(
    VkCommandBuffer                             commandBuffer,
    VkBlitImageInfo2 const*                     pBlitImageInfo);

VKAPI_ATTR void VKAPI_CALL vkCmdResolveImage2KHR(
    VkCommandBuffer                             commandBuffer,
    VkResolveImageInfo2 const*                  pResolveImageInfo);
#endif
...
typedef struct VkPipelineVertexInputDivisorStateCreateInfoKHR {
    ...
    VkVertexInputBindingDivisorDescriptionKHR const*    pVertexBindingDivisors;
...
typedef VkResult (VKAPI_PTR *PFN_vkGetCalibratedTimestampsKHR)(VkDevice device, uint32_t timestampCount, VkCalibratedTimestampInfoKHR const * pTimestampInfos, uint64_t* pTimestamps, uint64_t* pMaxDeviation);
...
static constexpr VkFormatFeatureFlagBits2 VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_FILTER_CUBIC_BIT {0x00002000ULL};
...
static constexpr VkFormatFeatureFlagBits2 VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_BIT_KHR {VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_BIT};
static constexpr VkFormatFeatureFlagBits2 VK_FORMAT_FEATURE_2_STORAGE_IMAGE_BIT_KHR {VK_FORMAT_FEATURE_2_STORAGE_IMAGE_BIT};
static constexpr VkFormatFeatureFlagBits2 VK_FORMAT_FEATURE_2_STORAGE_IMAGE_ATOMIC_BIT_KHR {VK_FORMAT_FEATURE_2_STORAGE_IMAGE_ATOMIC_BIT};
static constexpr VkFormatFeatureFlagBits2 VK_FORMAT_FEATURE_2_UNIFORM_TEXEL_BUFFER_BIT_KHR {VK_FORMAT_FEATURE_2_UNIFORM_TEXEL_BUFFER_BIT};
static constexpr VkFormatFeatureFlagBits2 VK_FORMAT_FEATURE_2_STORAGE_TEXEL_BUFFER_BIT_KHR {VK_FORMAT_FEATURE_2_STORAGE_TEXEL_BUFFER_BIT};
static constexpr VkFormatFeatureFlagBits2 VK_FORMAT_FEATURE_2_STORAGE_TEXEL_BUFFER_ATOMIC_BIT_KHR {VK_FORMAT_FEATURE_2_STORAGE_TEXEL_BUFFER_ATOMIC_BIT};
static constexpr VkFormatFeatureFlagBits2 VK_FORMAT_FEATURE_2_VERTEX_BUFFER_BIT_KHR {VK_FORMAT_FEATURE_2_VERTEX_BUFFER_BIT};
static constexpr VkFormatFeatureFlagBits2 VK_FORMAT_FEATURE_2_COLOR_ATTACHMENT_BIT_KHR {VK_FORMAT_FEATURE_2_COLOR_ATTACHMENT_BIT};
static constexpr VkFormatFeatureFlagBits2 VK_FORMAT_FEATURE_2_COLOR_ATTACHMENT_BLEND_BIT_KHR {VK_FORMAT_FEATURE_2_COLOR_ATTACHMENT_BLEND_BIT};
static constexpr VkFormatFeatureFlagBits2 VK_FORMAT_FEATURE_2_DEPTH_STENCIL_ATTACHMENT_BIT_KHR {VK_FORMAT_FEATURE_2_DEPTH_STENCIL_ATTACHMENT_BIT};
static constexpr VkFormatFeatureFlagBits2 VK_FORMAT_FEATURE_2_BLIT_SRC_BIT_KHR {VK_FORMAT_FEATURE_2_BLIT_SRC_BIT};
static constexpr VkFormatFeatureFlagBits2 VK_FORMAT_FEATURE_2_BLIT_DST_BIT_KHR {VK_FORMAT_FEATURE_2_BLIT_DST_BIT};
static constexpr VkFormatFeatureFlagBits2 VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_FILTER_LINEAR_BIT_KHR {VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_FILTER_LINEAR_BIT};
static constexpr VkFormatFeatureFlagBits2 VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_FILTER_CUBIC_BIT_EXT {VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_FILTER_CUBIC_BIT};
static constexpr VkFormatFeatureFlagBits2 VK_FORMAT_FEATURE_2_TRANSFER_SRC_BIT_KHR {VK_FORMAT_FEATURE_2_TRANSFER_SRC_BIT};
static constexpr VkFormatFeatureFlagBits2 VK_FORMAT_FEATURE_2_TRANSFER_DST_BIT_KHR {VK_FORMAT_FEATURE_2_TRANSFER_DST_BIT};
static constexpr VkFormatFeatureFlagBits2 VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_FILTER_MINMAX_BIT_KHR {VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_FILTER_MINMAX_BIT};
static constexpr VkFormatFeatureFlagBits2 VK_FORMAT_FEATURE_2_MIDPOINT_CHROMA_SAMPLES_BIT_KHR {VK_FORMAT_FEATURE_2_MIDPOINT_CHROMA_SAMPLES_BIT};
static constexpr VkFormatFeatureFlagBits2 VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_LINEAR_FILTER_BIT_KHR {VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_LINEAR_FILTER_BIT};
static constexpr VkFormatFeatureFlagBits2 VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_SEPARATE_RECONSTRUCTION_FILTER_BIT_KHR {VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_SEPARATE_RECONSTRUCTION_FILTER_BIT};
static constexpr VkFormatFeatureFlagBits2 VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_BIT_KHR {VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_BIT};
static constexpr VkFormatFeatureFlagBits2 VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_FORCEABLE_BIT_KHR {VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_FORCEABLE_BIT};
static constexpr VkFormatFeatureFlagBits2 VK_FORMAT_FEATURE_2_DISJOINT_BIT_KHR {VK_FORMAT_FEATURE_2_DISJOINT_BIT};
static constexpr VkFormatFeatureFlagBits2 VK_FORMAT_FEATURE_2_COSITED_CHROMA_SAMPLES_BIT_KHR {VK_FORMAT_FEATURE_2_COSITED_CHROMA_SAMPLES_BIT};
static constexpr VkFormatFeatureFlagBits2 VK_FORMAT_FEATURE_2_STORAGE_READ_WITHOUT_FORMAT_BIT_KHR {VK_FORMAT_FEATURE_2_STORAGE_READ_WITHOUT_FORMAT_BIT};
static constexpr VkFormatFeatureFlagBits2 VK_FORMAT_FEATURE_2_STORAGE_WRITE_WITHOUT_FORMAT_BIT_KHR {VK_FORMAT_FEATURE_2_STORAGE_WRITE_WITHOUT_FORMAT_BIT};
static constexpr VkFormatFeatureFlagBits2 VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_DEPTH_COMPARISON_BIT_KHR {VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_DEPTH_COMPARISON_BIT};
