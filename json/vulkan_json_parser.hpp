...
static std::map<std::string, int> VkStructureType_map = {
    ...
    std::make_pair("VK_STRUCTURE_TYPE_OH_SURFACE_CREATE_INFO_OHOS", 1000587000),
...
static std::map<std::string, int> VkQueueFlagBits_map = {
    ...
    std::make_pair("VK_QUEUE_RESERVED_9_BIT_EXT", 1UL << 9),
...
static std::map<std::string, int> VkAttachmentDescriptionFlagBits_map = {
    ...
    std::make_pair("VK_ATTACHMENT_DESCRIPTION_RESERVED_1_BIT_KHR", 1UL << 1),
    std::make_pair("VK_ATTACHMENT_DESCRIPTION_RESERVED_2_BIT_KHR", 1UL << 2),
};
...
static std::map<std::string, uint64_t> VkPipelineStageFlagBits2_map = {
    ...
    std::make_pair("VK_PIPELINE_STAGE_2_RESERVED_46_BIT_NV", 1ULL << 46),
...
static std::map<std::string, uint64_t> VkFormatFeatureFlagBits2_map = {
    ...
    std::make_pair("VK_FORMAT_FEATURE_2_RESERVED_52_BIT_KHR", 1ULL << 52),
    std::make_pair("VK_FORMAT_FEATURE_2_RESERVED_53_BIT_KHR", 1ULL << 53),
    std::make_pair("VK_FORMAT_FEATURE_2_RESERVED_54_BIT_KHR", 1ULL << 54),
    std::make_pair("VK_FORMAT_FEATURE_2_RESERVED_55_BIT_KHR", 1ULL << 55),
