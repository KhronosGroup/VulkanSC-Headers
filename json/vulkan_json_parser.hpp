...
static void parse_uint32_t(const Json::Value& obj, uint32_t& o)
{
     if (obj.isString())
          if (obj.asString() == "VK_MAX_PHYSICAL_DEVICE_NAME_SIZE")
               ...
               o = (~0U);
          else if (obj.asString() == "VK_MAX_GLOBAL_PRIORITY_SIZE")
               o = 16;
          else if (obj.asString() == "VK_MAX_SHADER_MODULE_IDENTIFIER_SIZE_EXT")
               o = 32;
          else if (obj.asString() == "VK_MAX_PIPELINE_BINARY_KEY_SIZE_KHR")
               o = 32;
          else if (obj.asString() == "VK_MAX_VIDEO_AV1_REFERENCES_PER_FRAME_KHR")
               o = 7;
          else if (obj.asString() == "VK_MAX_VIDEO_VP9_REFERENCES_PER_FRAME_KHR")
               o = 3;
          else if (obj.asString() == "VK_SHADER_INDEX_UNUSED_AMDX")
               o = (~0U);
          else if (obj.asString() == "VK_PARTITIONED_ACCELERATION_STRUCTURE_PARTITION_INDEX_GLOBAL_NV")
               o = (~0U);
          else if (obj.asString() == "VK_COMPRESSED_TRIANGLE_FORMAT_DGF1_BYTE_ALIGNMENT_AMDX")
               o = 128;
          else if (obj.asString() == "VK_COMPRESSED_TRIANGLE_FORMAT_DGF1_BYTE_STRIDE_AMDX")
               o = 128;
          else if (obj.asString() == "VK_MAX_PHYSICAL_DEVICE_DATA_GRAPH_OPERATION_SET_NAME_SIZE_ARM")
               o = 128;
          else
               assert(false);
     else
...
static void parse_NvSciBufAttrList(const Json::Value& obj, NvSciBufAttrList& o)
{
     o = static_cast<NvSciBufAttrList>(obj.asInt());
}

static void parse_NvSciBufObj(const Json::Value& obj, NvSciBufObj& o)
{
     o = static_cast<NvSciBufObj>(obj.asInt());
}
...
static void parse_NvSciSyncObj(const Json::Value& obj, NvSciSyncObj& o)
{
     o = static_cast<NvSciSyncObj>(obj.asInt());
}
...
static std::map<std::string, int> VkResult_map = {
    ...
    std::make_pair("VK_ERROR_NOT_PERMITTED", 1000174001),
    ...
    std::make_pair("VK_PIPELINE_BINARY_MISSING_KHR", 1000483000),
    std::make_pair("VK_ERROR_NOT_ENOUGH_SPACE_KHR", 1000483000),
};
...
static std::map<std::string, int> VkStructureType_map = {
    ...
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_4_FEATURES", 55),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_4_PROPERTIES", 56),
    std::make_pair("VK_STRUCTURE_TYPE_DEVICE_QUEUE_GLOBAL_PRIORITY_CREATE_INFO", 1000174000),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_GLOBAL_PRIORITY_QUERY_FEATURES", 1000388000),
    std::make_pair("VK_STRUCTURE_TYPE_QUEUE_FAMILY_GLOBAL_PRIORITY_PROPERTIES", 1000388001),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_INDEX_TYPE_UINT8_FEATURES", 1000265000),
    std::make_pair("VK_STRUCTURE_TYPE_MEMORY_MAP_INFO", 1000271000),
    std::make_pair("VK_STRUCTURE_TYPE_MEMORY_UNMAP_INFO", 1000271001),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_5_FEATURES", 1000470000),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_5_PROPERTIES", 1000470001),
    std::make_pair("VK_STRUCTURE_TYPE_DEVICE_IMAGE_SUBRESOURCE_INFO", 1000470004),
    std::make_pair("VK_STRUCTURE_TYPE_SUBRESOURCE_LAYOUT_2", 1000338002),
    std::make_pair("VK_STRUCTURE_TYPE_IMAGE_SUBRESOURCE_2", 1000338003),
    std::make_pair("VK_STRUCTURE_TYPE_BUFFER_USAGE_FLAGS_2_CREATE_INFO", 1000470006),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_6_FEATURES", 1000545000),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_6_PROPERTIES", 1000545001),
    std::make_pair("VK_STRUCTURE_TYPE_BIND_MEMORY_STATUS", 1000545002),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_HOST_IMAGE_COPY_FEATURES", 1000270000),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_HOST_IMAGE_COPY_PROPERTIES", 1000270001),
    std::make_pair("VK_STRUCTURE_TYPE_MEMORY_TO_IMAGE_COPY", 1000270002),
    std::make_pair("VK_STRUCTURE_TYPE_IMAGE_TO_MEMORY_COPY", 1000270003),
    std::make_pair("VK_STRUCTURE_TYPE_COPY_IMAGE_TO_MEMORY_INFO", 1000270004),
    std::make_pair("VK_STRUCTURE_TYPE_COPY_MEMORY_TO_IMAGE_INFO", 1000270005),
    std::make_pair("VK_STRUCTURE_TYPE_HOST_IMAGE_LAYOUT_TRANSITION_INFO", 1000270006),
    std::make_pair("VK_STRUCTURE_TYPE_COPY_IMAGE_TO_IMAGE_INFO", 1000270007),
    std::make_pair("VK_STRUCTURE_TYPE_SUBRESOURCE_HOST_MEMCPY_SIZE", 1000270008),
    std::make_pair("VK_STRUCTURE_TYPE_HOST_IMAGE_COPY_DEVICE_PERFORMANCE_QUERY", 1000270009),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_SUBGROUP_ROTATE_FEATURES", 1000416000),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_FLOAT_CONTROLS_2_FEATURES", 1000528000),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_EXPECT_ASSUME_FEATURES", 1000544000),
    std::make_pair("VK_STRUCTURE_TYPE_PIPELINE_CREATE_FLAGS_2_CREATE_INFO", 1000470005),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PUSH_DESCRIPTOR_PROPERTIES", 1000080000),
    std::make_pair("VK_STRUCTURE_TYPE_BIND_DESCRIPTOR_SETS_INFO", 1000545003),
    std::make_pair("VK_STRUCTURE_TYPE_PUSH_CONSTANTS_INFO", 1000545004),
    std::make_pair("VK_STRUCTURE_TYPE_PUSH_DESCRIPTOR_SET_INFO", 1000545005),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_PROTECTED_ACCESS_FEATURES", 1000466000),
    std::make_pair("VK_STRUCTURE_TYPE_PIPELINE_ROBUSTNESS_CREATE_INFO", 1000068000),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_ROBUSTNESS_FEATURES", 1000068001),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_ROBUSTNESS_PROPERTIES", 1000068002),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LINE_RASTERIZATION_FEATURES", 1000259000),
    std::make_pair("VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_LINE_STATE_CREATE_INFO", 1000259001),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LINE_RASTERIZATION_PROPERTIES", 1000259002),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_PROPERTIES", 1000525000),
    std::make_pair("VK_STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_DIVISOR_STATE_CREATE_INFO", 1000190001),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_FEATURES", 1000190002),
    std::make_pair("VK_STRUCTURE_TYPE_RENDERING_AREA_INFO", 1000470003),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DYNAMIC_RENDERING_LOCAL_READ_FEATURES", 1000232000),
    std::make_pair("VK_STRUCTURE_TYPE_RENDERING_ATTACHMENT_LOCATION_INFO", 1000232001),
    std::make_pair("VK_STRUCTURE_TYPE_RENDERING_INPUT_ATTACHMENT_INDEX_INFO", 1000232002),
    ...
    std::make_pair("VK_STRUCTURE_TYPE_CU_MODULE_TEXTURING_MODE_CREATE_INFO_NVX", 1000029004),
    ...
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_BFLOAT16_FEATURES_KHR", 1000141000),
    ...
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TILE_SHADING_FEATURES_QCOM", 1000309000),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TILE_SHADING_PROPERTIES_QCOM", 1000309001),
    std::make_pair("VK_STRUCTURE_TYPE_RENDER_PASS_TILE_SHADING_CREATE_INFO_QCOM", 1000309002),
    std::make_pair("VK_STRUCTURE_TYPE_PER_TILE_BEGIN_INFO_QCOM", 1000309003),
    std::make_pair("VK_STRUCTURE_TYPE_PER_TILE_END_INFO_QCOM", 1000309004),
    std::make_pair("VK_STRUCTURE_TYPE_DISPATCH_TILE_INFO_QCOM", 1000309005),
    ...
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRESENT_MODE_FIFO_LATEST_READY_FEATURES_EXT", 1000361000),
    ...
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_UNTYPED_POINTERS_FEATURES_KHR", 1000387000),
    ...
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VIDEO_ENCODE_RGB_CONVERSION_FEATURES_VALVE", 1000390000),
    std::make_pair("VK_STRUCTURE_TYPE_VIDEO_ENCODE_RGB_CONVERSION_CAPABILITIES_VALVE", 1000390001),
    std::make_pair("VK_STRUCTURE_TYPE_VIDEO_ENCODE_PROFILE_RGB_CONVERSION_INFO_VALVE", 1000390002),
    std::make_pair("VK_STRUCTURE_TYPE_VIDEO_ENCODE_SESSION_RGB_CONVERSION_CREATE_INFO_VALVE", 1000390003),
    ...
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_LINEAR_SWEPT_SPHERES_FEATURES_NV", 1000429008),
    std::make_pair("VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_GEOMETRY_LINEAR_SWEPT_SPHERES_DATA_NV", 1000429009),
    std::make_pair("VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_GEOMETRY_SPHERES_DATA_NV", 1000429010),
    ...
    std::make_pair("VK_STRUCTURE_TYPE_TENSOR_CREATE_INFO_ARM", 1000460000),
    std::make_pair("VK_STRUCTURE_TYPE_TENSOR_VIEW_CREATE_INFO_ARM", 1000460001),
    std::make_pair("VK_STRUCTURE_TYPE_BIND_TENSOR_MEMORY_INFO_ARM", 1000460002),
    std::make_pair("VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET_TENSOR_ARM", 1000460003),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TENSOR_PROPERTIES_ARM", 1000460004),
    std::make_pair("VK_STRUCTURE_TYPE_TENSOR_FORMAT_PROPERTIES_ARM", 1000460005),
    std::make_pair("VK_STRUCTURE_TYPE_TENSOR_DESCRIPTION_ARM", 1000460006),
    std::make_pair("VK_STRUCTURE_TYPE_TENSOR_MEMORY_REQUIREMENTS_INFO_ARM", 1000460007),
    std::make_pair("VK_STRUCTURE_TYPE_TENSOR_MEMORY_BARRIER_ARM", 1000460008),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TENSOR_FEATURES_ARM", 1000460009),
    std::make_pair("VK_STRUCTURE_TYPE_DEVICE_TENSOR_MEMORY_REQUIREMENTS_ARM", 1000460010),
    std::make_pair("VK_STRUCTURE_TYPE_COPY_TENSOR_INFO_ARM", 1000460011),
    std::make_pair("VK_STRUCTURE_TYPE_TENSOR_COPY_ARM", 1000460012),
    std::make_pair("VK_STRUCTURE_TYPE_TENSOR_DEPENDENCY_INFO_ARM", 1000460013),
    std::make_pair("VK_STRUCTURE_TYPE_MEMORY_DEDICATED_ALLOCATE_INFO_TENSOR_ARM", 1000460014),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_TENSOR_INFO_ARM", 1000460015),
    std::make_pair("VK_STRUCTURE_TYPE_EXTERNAL_TENSOR_PROPERTIES_ARM", 1000460016),
    std::make_pair("VK_STRUCTURE_TYPE_EXTERNAL_MEMORY_TENSOR_CREATE_INFO_ARM", 1000460017),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_BUFFER_TENSOR_FEATURES_ARM", 1000460018),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_BUFFER_TENSOR_PROPERTIES_ARM", 1000460019),
    std::make_pair("VK_STRUCTURE_TYPE_DESCRIPTOR_GET_TENSOR_INFO_ARM", 1000460020),
    std::make_pair("VK_STRUCTURE_TYPE_TENSOR_CAPTURE_DESCRIPTOR_DATA_INFO_ARM", 1000460021),
    std::make_pair("VK_STRUCTURE_TYPE_TENSOR_VIEW_CAPTURE_DESCRIPTOR_DATA_INFO_ARM", 1000460022),
    std::make_pair("VK_STRUCTURE_TYPE_FRAME_BOUNDARY_TENSORS_ARM", 1000460023),
    ...
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ANTI_LAG_FEATURES_AMD", 1000476000),
    std::make_pair("VK_STRUCTURE_TYPE_ANTI_LAG_DATA_AMD", 1000476001),
    std::make_pair("VK_STRUCTURE_TYPE_ANTI_LAG_PRESENTATION_INFO_AMD", 1000476002),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DENSE_GEOMETRY_FORMAT_FEATURES_AMDX", 1000478000),
    std::make_pair("VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_DENSE_GEOMETRY_FORMAT_TRIANGLES_DATA_AMDX", 1000478001),
    std::make_pair("VK_STRUCTURE_TYPE_SURFACE_CAPABILITIES_PRESENT_ID_2_KHR", 1000479000),
    std::make_pair("VK_STRUCTURE_TYPE_PRESENT_ID_2_KHR", 1000479001),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRESENT_ID_2_FEATURES_KHR", 1000479002),
    std::make_pair("VK_STRUCTURE_TYPE_SURFACE_CAPABILITIES_PRESENT_WAIT_2_KHR", 1000480000),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRESENT_WAIT_2_FEATURES_KHR", 1000480001),
    std::make_pair("VK_STRUCTURE_TYPE_PRESENT_WAIT_2_INFO_KHR", 1000480002),
    ...
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_BINARY_FEATURES_KHR", 1000483000),
    std::make_pair("VK_STRUCTURE_TYPE_PIPELINE_BINARY_CREATE_INFO_KHR", 1000483001),
    std::make_pair("VK_STRUCTURE_TYPE_PIPELINE_BINARY_INFO_KHR", 1000483002),
    std::make_pair("VK_STRUCTURE_TYPE_PIPELINE_BINARY_KEY_KHR", 1000483003),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_BINARY_PROPERTIES_KHR", 1000483004),
    std::make_pair("VK_STRUCTURE_TYPE_RELEASE_CAPTURED_PIPELINE_DATA_INFO_KHR", 1000483005),
    std::make_pair("VK_STRUCTURE_TYPE_PIPELINE_BINARY_DATA_INFO_KHR", 1000483006),
    std::make_pair("VK_STRUCTURE_TYPE_PIPELINE_CREATE_INFO_KHR", 1000483007),
    std::make_pair("VK_STRUCTURE_TYPE_DEVICE_PIPELINE_BINARY_INTERNAL_CACHE_CONTROL_KHR", 1000483008),
    std::make_pair("VK_STRUCTURE_TYPE_PIPELINE_BINARY_HANDLES_INFO_KHR", 1000483009),
    ...
    std::make_pair("VK_STRUCTURE_TYPE_SURFACE_PRESENT_MODE_KHR", 1000274000),
    std::make_pair("VK_STRUCTURE_TYPE_SURFACE_PRESENT_SCALING_CAPABILITIES_KHR", 1000274001),
    std::make_pair("VK_STRUCTURE_TYPE_SURFACE_PRESENT_MODE_COMPATIBILITY_KHR", 1000274002),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SWAPCHAIN_MAINTENANCE_1_FEATURES_KHR", 1000275000),
    std::make_pair("VK_STRUCTURE_TYPE_SWAPCHAIN_PRESENT_FENCE_INFO_KHR", 1000275001),
    std::make_pair("VK_STRUCTURE_TYPE_SWAPCHAIN_PRESENT_MODES_CREATE_INFO_KHR", 1000275002),
    std::make_pair("VK_STRUCTURE_TYPE_SWAPCHAIN_PRESENT_MODE_INFO_KHR", 1000275003),
    std::make_pair("VK_STRUCTURE_TYPE_SWAPCHAIN_PRESENT_SCALING_CREATE_INFO_KHR", 1000275004),
    std::make_pair("VK_STRUCTURE_TYPE_RELEASE_SWAPCHAIN_IMAGES_INFO_KHR", 1000275005),
    ...
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COOPERATIVE_VECTOR_FEATURES_NV", 1000491000),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COOPERATIVE_VECTOR_PROPERTIES_NV", 1000491001),
    std::make_pair("VK_STRUCTURE_TYPE_COOPERATIVE_VECTOR_PROPERTIES_NV", 1000491002),
    std::make_pair("VK_STRUCTURE_TYPE_CONVERT_COOPERATIVE_VECTOR_MATRIX_INFO_NV", 1000491004),
    ...
    std::make_pair("VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_CREATE_INFO_ARM", 1000507000),
    std::make_pair("VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_SESSION_CREATE_INFO_ARM", 1000507001),
    std::make_pair("VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_RESOURCE_INFO_ARM", 1000507002),
    std::make_pair("VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_CONSTANT_ARM", 1000507003),
    std::make_pair("VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_SESSION_MEMORY_REQUIREMENTS_INFO_ARM", 1000507004),
    std::make_pair("VK_STRUCTURE_TYPE_BIND_DATA_GRAPH_PIPELINE_SESSION_MEMORY_INFO_ARM", 1000507005),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DATA_GRAPH_FEATURES_ARM", 1000507006),
    std::make_pair("VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_SHADER_MODULE_CREATE_INFO_ARM", 1000507007),
    std::make_pair("VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_PROPERTY_QUERY_RESULT_ARM", 1000507008),
    std::make_pair("VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_INFO_ARM", 1000507009),
    std::make_pair("VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_COMPILER_CONTROL_CREATE_INFO_ARM", 1000507010),
    std::make_pair("VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_SESSION_BIND_POINT_REQUIREMENTS_INFO_ARM", 1000507011),
    std::make_pair("VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_SESSION_BIND_POINT_REQUIREMENT_ARM", 1000507012),
    std::make_pair("VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_IDENTIFIER_CREATE_INFO_ARM", 1000507013),
    std::make_pair("VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_DISPATCH_INFO_ARM", 1000507014),
    std::make_pair("VK_STRUCTURE_TYPE_DATA_GRAPH_PROCESSING_ENGINE_CREATE_INFO_ARM", 1000507016),
    std::make_pair("VK_STRUCTURE_TYPE_QUEUE_FAMILY_DATA_GRAPH_PROCESSING_ENGINE_PROPERTIES_ARM", 1000507017),
    std::make_pair("VK_STRUCTURE_TYPE_QUEUE_FAMILY_DATA_GRAPH_PROPERTIES_ARM", 1000507018),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_QUEUE_FAMILY_DATA_GRAPH_PROCESSING_ENGINE_INFO_ARM", 1000507019),
    std::make_pair("VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_CONSTANT_TENSOR_SEMI_STRUCTURED_SPARSITY_INFO_ARM", 1000507015),
    ...
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COMPUTE_SHADER_DERIVATIVES_FEATURES_KHR", 1000201000),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COMPUTE_SHADER_DERIVATIVES_PROPERTIES_KHR", 1000511000),
    ...
    std::make_pair("VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_CAPABILITIES_KHR", 1000513000),
    std::make_pair("VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_SESSION_PARAMETERS_CREATE_INFO_KHR", 1000513001),
    std::make_pair("VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_PICTURE_INFO_KHR", 1000513002),
    std::make_pair("VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_DPB_SLOT_INFO_KHR", 1000513003),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VIDEO_ENCODE_AV1_FEATURES_KHR", 1000513004),
    std::make_pair("VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_PROFILE_INFO_KHR", 1000513005),
    std::make_pair("VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_RATE_CONTROL_INFO_KHR", 1000513006),
    std::make_pair("VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_RATE_CONTROL_LAYER_INFO_KHR", 1000513007),
    std::make_pair("VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_QUALITY_LEVEL_PROPERTIES_KHR", 1000513008),
    std::make_pair("VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_SESSION_CREATE_INFO_KHR", 1000513009),
    std::make_pair("VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_GOP_REMAINING_FRAME_INFO_KHR", 1000513010),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VIDEO_DECODE_VP9_FEATURES_KHR", 1000514000),
    std::make_pair("VK_STRUCTURE_TYPE_VIDEO_DECODE_VP9_CAPABILITIES_KHR", 1000514001),
    std::make_pair("VK_STRUCTURE_TYPE_VIDEO_DECODE_VP9_PICTURE_INFO_KHR", 1000514002),
    std::make_pair("VK_STRUCTURE_TYPE_VIDEO_DECODE_VP9_PROFILE_INFO_KHR", 1000514003),
    ...
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_UNIFIED_IMAGE_LAYOUTS_FEATURES_KHR", 1000527000),
    std::make_pair("VK_STRUCTURE_TYPE_ATTACHMENT_FEEDBACK_LOOP_INFO_EXT", 1000527001),
    ...
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TILE_MEMORY_HEAP_FEATURES_QCOM", 1000547000),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TILE_MEMORY_HEAP_PROPERTIES_QCOM", 1000547001),
    std::make_pair("VK_STRUCTURE_TYPE_TILE_MEMORY_REQUIREMENTS_QCOM", 1000547002),
    std::make_pair("VK_STRUCTURE_TYPE_TILE_MEMORY_BIND_INFO_QCOM", 1000547003),
    std::make_pair("VK_STRUCTURE_TYPE_TILE_MEMORY_SIZE_INFO_QCOM", 1000547004),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COPY_MEMORY_INDIRECT_FEATURES_KHR", 1000549000),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COPY_MEMORY_INDIRECT_PROPERTIES_KHR", 1000426001),
    std::make_pair("VK_STRUCTURE_TYPE_COPY_MEMORY_INDIRECT_INFO_KHR", 1000549002),
    std::make_pair("VK_STRUCTURE_TYPE_COPY_MEMORY_TO_IMAGE_INDIRECT_INFO_KHR", 1000549003),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MEMORY_DECOMPRESSION_FEATURES_EXT", 1000427000),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MEMORY_DECOMPRESSION_PROPERTIES_EXT", 1000427001),
    std::make_pair("VK_STRUCTURE_TYPE_DECOMPRESS_MEMORY_INFO_EXT", 1000550002),
    std::make_pair("VK_STRUCTURE_TYPE_DISPLAY_SURFACE_STEREO_CREATE_INFO_NV", 1000551000),
    std::make_pair("VK_STRUCTURE_TYPE_DISPLAY_MODE_STEREO_PROPERTIES_NV", 1000551001),
    std::make_pair("VK_STRUCTURE_TYPE_VIDEO_ENCODE_INTRA_REFRESH_CAPABILITIES_KHR", 1000552000),
    std::make_pair("VK_STRUCTURE_TYPE_VIDEO_ENCODE_SESSION_INTRA_REFRESH_CREATE_INFO_KHR", 1000552001),
    std::make_pair("VK_STRUCTURE_TYPE_VIDEO_ENCODE_INTRA_REFRESH_INFO_KHR", 1000552002),
    std::make_pair("VK_STRUCTURE_TYPE_VIDEO_REFERENCE_INTRA_REFRESH_INFO_KHR", 1000552003),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VIDEO_ENCODE_INTRA_REFRESH_FEATURES_KHR", 1000552004),
    std::make_pair("VK_STRUCTURE_TYPE_VIDEO_ENCODE_QUANTIZATION_MAP_CAPABILITIES_KHR", 1000553000),
    std::make_pair("VK_STRUCTURE_TYPE_VIDEO_FORMAT_QUANTIZATION_MAP_PROPERTIES_KHR", 1000553001),
    std::make_pair("VK_STRUCTURE_TYPE_VIDEO_ENCODE_QUANTIZATION_MAP_INFO_KHR", 1000553002),
    std::make_pair("VK_STRUCTURE_TYPE_VIDEO_ENCODE_QUANTIZATION_MAP_SESSION_PARAMETERS_CREATE_INFO_KHR", 1000553005),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VIDEO_ENCODE_QUANTIZATION_MAP_FEATURES_KHR", 1000553009),
    std::make_pair("VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_QUANTIZATION_MAP_CAPABILITIES_KHR", 1000553003),
    std::make_pair("VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_QUANTIZATION_MAP_CAPABILITIES_KHR", 1000553004),
    std::make_pair("VK_STRUCTURE_TYPE_VIDEO_FORMAT_H265_QUANTIZATION_MAP_PROPERTIES_KHR", 1000553006),
    std::make_pair("VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_QUANTIZATION_MAP_CAPABILITIES_KHR", 1000553007),
    std::make_pair("VK_STRUCTURE_TYPE_VIDEO_FORMAT_AV1_QUANTIZATION_MAP_PROPERTIES_KHR", 1000553008),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAW_ACCESS_CHAINS_FEATURES_NV", 1000555000),
    std::make_pair("VK_STRUCTURE_TYPE_EXTERNAL_COMPUTE_QUEUE_DEVICE_CREATE_INFO_NV", 1000556000),
    std::make_pair("VK_STRUCTURE_TYPE_EXTERNAL_COMPUTE_QUEUE_CREATE_INFO_NV", 1000556001),
    std::make_pair("VK_STRUCTURE_TYPE_EXTERNAL_COMPUTE_QUEUE_DATA_PARAMS_NV", 1000556002),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_COMPUTE_QUEUE_PROPERTIES_NV", 1000556003),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_RELAXED_EXTENDED_INSTRUCTION_FEATURES_KHR", 1000558000),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COMMAND_BUFFER_INHERITANCE_FEATURES_NV", 1000559000),
    ...
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_FLOAT8_FEATURES_EXT", 1000567000),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_VALIDATION_FEATURES_NV", 1000568000),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CLUSTER_ACCELERATION_STRUCTURE_FEATURES_NV", 1000569000),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CLUSTER_ACCELERATION_STRUCTURE_PROPERTIES_NV", 1000569001),
    std::make_pair("VK_STRUCTURE_TYPE_CLUSTER_ACCELERATION_STRUCTURE_CLUSTERS_BOTTOM_LEVEL_INPUT_NV", 1000569002),
    std::make_pair("VK_STRUCTURE_TYPE_CLUSTER_ACCELERATION_STRUCTURE_TRIANGLE_CLUSTER_INPUT_NV", 1000569003),
    std::make_pair("VK_STRUCTURE_TYPE_CLUSTER_ACCELERATION_STRUCTURE_MOVE_OBJECTS_INPUT_NV", 1000569004),
    std::make_pair("VK_STRUCTURE_TYPE_CLUSTER_ACCELERATION_STRUCTURE_INPUT_INFO_NV", 1000569005),
    std::make_pair("VK_STRUCTURE_TYPE_CLUSTER_ACCELERATION_STRUCTURE_COMMANDS_INFO_NV", 1000569006),
    std::make_pair("VK_STRUCTURE_TYPE_RAY_TRACING_PIPELINE_CLUSTER_ACCELERATION_STRUCTURE_CREATE_INFO_NV", 1000569007),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PARTITIONED_ACCELERATION_STRUCTURE_FEATURES_NV", 1000570000),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PARTITIONED_ACCELERATION_STRUCTURE_PROPERTIES_NV", 1000570001),
    std::make_pair("VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET_PARTITIONED_ACCELERATION_STRUCTURE_NV", 1000570002),
    std::make_pair("VK_STRUCTURE_TYPE_PARTITIONED_ACCELERATION_STRUCTURE_INSTANCES_INPUT_NV", 1000570003),
    std::make_pair("VK_STRUCTURE_TYPE_BUILD_PARTITIONED_ACCELERATION_STRUCTURE_INFO_NV", 1000570004),
    std::make_pair("VK_STRUCTURE_TYPE_PARTITIONED_ACCELERATION_STRUCTURE_FLAGS_NV", 1000570005),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEVICE_GENERATED_COMMANDS_FEATURES_EXT", 1000572000),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEVICE_GENERATED_COMMANDS_PROPERTIES_EXT", 1000572001),
    std::make_pair("VK_STRUCTURE_TYPE_GENERATED_COMMANDS_MEMORY_REQUIREMENTS_INFO_EXT", 1000572002),
    std::make_pair("VK_STRUCTURE_TYPE_INDIRECT_EXECUTION_SET_CREATE_INFO_EXT", 1000572003),
    std::make_pair("VK_STRUCTURE_TYPE_GENERATED_COMMANDS_INFO_EXT", 1000572004),
    std::make_pair("VK_STRUCTURE_TYPE_INDIRECT_COMMANDS_LAYOUT_CREATE_INFO_EXT", 1000572006),
    std::make_pair("VK_STRUCTURE_TYPE_INDIRECT_COMMANDS_LAYOUT_TOKEN_EXT", 1000572007),
    std::make_pair("VK_STRUCTURE_TYPE_WRITE_INDIRECT_EXECUTION_SET_PIPELINE_EXT", 1000572008),
    std::make_pair("VK_STRUCTURE_TYPE_WRITE_INDIRECT_EXECUTION_SET_SHADER_EXT", 1000572009),
    std::make_pair("VK_STRUCTURE_TYPE_INDIRECT_EXECUTION_SET_PIPELINE_INFO_EXT", 1000572010),
    std::make_pair("VK_STRUCTURE_TYPE_INDIRECT_EXECUTION_SET_SHADER_INFO_EXT", 1000572011),
    std::make_pair("VK_STRUCTURE_TYPE_INDIRECT_EXECUTION_SET_SHADER_LAYOUT_INFO_EXT", 1000572012),
    std::make_pair("VK_STRUCTURE_TYPE_GENERATED_COMMANDS_PIPELINE_INFO_EXT", 1000572013),
    std::make_pair("VK_STRUCTURE_TYPE_GENERATED_COMMANDS_SHADER_INFO_EXT", 1000572014),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_8_FEATURES_KHR", 1000574000),
    std::make_pair("VK_STRUCTURE_TYPE_MEMORY_BARRIER_ACCESS_FLAGS_3_KHR", 1000574002),
    ...
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_FMA_FEATURES_KHR", 1000579000),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEPTH_CLAMP_CONTROL_FEATURES_EXT", 1000582000),
    std::make_pair("VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_DEPTH_CLAMP_CONTROL_CREATE_INFO_EXT", 1000582001),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_9_FEATURES_KHR", 1000584000),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_9_PROPERTIES_KHR", 1000584001),
    std::make_pair("VK_STRUCTURE_TYPE_QUEUE_FAMILY_OWNERSHIP_TRANSFER_PROPERTIES_KHR", 1000584002),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VIDEO_MAINTENANCE_2_FEATURES_KHR", 1000586000),
    std::make_pair("VK_STRUCTURE_TYPE_VIDEO_DECODE_H264_INLINE_SESSION_PARAMETERS_INFO_KHR", 1000586001),
    std::make_pair("VK_STRUCTURE_TYPE_VIDEO_DECODE_H265_INLINE_SESSION_PARAMETERS_INFO_KHR", 1000586002),
    std::make_pair("VK_STRUCTURE_TYPE_VIDEO_DECODE_AV1_INLINE_SESSION_PARAMETERS_INFO_KHR", 1000586003),
    std::make_pair("VK_STRUCTURE_TYPE_SURFACE_CREATE_INFO_OHOS", 1000685000),
    std::make_pair("VK_STRUCTURE_TYPE_NATIVE_BUFFER_OHOS", 1000453001),
    std::make_pair("VK_STRUCTURE_TYPE_SWAPCHAIN_IMAGE_CREATE_INFO_OHOS", 1000453002),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRESENTATION_PROPERTIES_OHOS", 1000453003),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_HDR_VIVID_FEATURES_HUAWEI", 1000590000),
    std::make_pair("VK_STRUCTURE_TYPE_HDR_VIVID_DYNAMIC_METADATA_HUAWEI", 1000590001),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COOPERATIVE_MATRIX_2_FEATURES_NV", 1000593000),
    std::make_pair("VK_STRUCTURE_TYPE_COOPERATIVE_MATRIX_FLEXIBLE_DIMENSIONS_PROPERTIES_NV", 1000593001),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COOPERATIVE_MATRIX_2_PROPERTIES_NV", 1000593002),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_OPACITY_MICROMAP_FEATURES_ARM", 1000596000),
    std::make_pair("VK_STRUCTURE_TYPE_IMPORT_MEMORY_METAL_HANDLE_INFO_EXT", 1000602000),
    std::make_pair("VK_STRUCTURE_TYPE_MEMORY_METAL_HANDLE_PROPERTIES_EXT", 1000602001),
    std::make_pair("VK_STRUCTURE_TYPE_MEMORY_GET_METAL_HANDLE_INFO_EXT", 1000602002),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEPTH_CLAMP_ZERO_ONE_FEATURES_KHR", 1000421000),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_ROBUSTNESS_FEATURES_EXT", 1000608000),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FORMAT_PACK_FEATURES_ARM", 1000609000),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_LAYERED_FEATURES_VALVE", 1000611000),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_LAYERED_PROPERTIES_VALVE", 1000611001),
    std::make_pair("VK_STRUCTURE_TYPE_PIPELINE_FRAGMENT_DENSITY_MAP_LAYERED_CREATE_INFO_VALVE", 1000611002),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ROBUSTNESS_2_FEATURES_KHR", 1000286000),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ROBUSTNESS_2_PROPERTIES_KHR", 1000286001),
    std::make_pair("VK_STRUCTURE_TYPE_SET_PRESENT_CONFIG_NV", 1000613000),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRESENT_METERING_FEATURES_NV", 1000613001),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_OFFSET_FEATURES_EXT", 1000425000),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_OFFSET_PROPERTIES_EXT", 1000425001),
    std::make_pair("VK_STRUCTURE_TYPE_RENDER_PASS_FRAGMENT_DENSITY_MAP_OFFSET_END_INFO_EXT", 1000425002),
    std::make_pair("VK_STRUCTURE_TYPE_RENDERING_END_INFO_EXT", 1000619003),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ZERO_INITIALIZE_DEVICE_MEMORY_FEATURES_EXT", 1000620000),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRESENT_MODE_FIFO_LATEST_READY_FEATURES_KHR", 1000361000),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_64_BIT_INDEXING_FEATURES_EXT", 1000627000),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_10_FEATURES_KHR", 1000630000),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_10_PROPERTIES_KHR", 1000630001),
    std::make_pair("VK_STRUCTURE_TYPE_RENDERING_ATTACHMENT_FLAGS_INFO_KHR", 1000630002),
    std::make_pair("VK_STRUCTURE_TYPE_RENDERING_END_INFO_KHR", 1000619003),
    std::make_pair("VK_STRUCTURE_TYPE_RESOLVE_IMAGE_MODE_INFO_KHR", 1000630004),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_CACHE_INCREMENTAL_MODE_FEATURES_SEC", 1000637000),
    std::make_pair("VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_UNIFORM_BUFFER_UNSIZED_ARRAY_FEATURES_EXT", 1000642000),
};
...
static std::map<std::string, int> VkAccessFlagBits_map = {
    ...
    std::make_pair("VK_ACCESS_COMMAND_PREPROCESS_READ_BIT_EXT", 1UL << 17),
    std::make_pair("VK_ACCESS_COMMAND_PREPROCESS_WRITE_BIT_EXT", 1UL << 18),
};
...
static std::map<std::string, int> VkImageLayout_map = {
    ...
    std::make_pair("VK_IMAGE_LAYOUT_RENDERING_LOCAL_READ", 1000232000),
    ...
    std::make_pair("VK_IMAGE_LAYOUT_TENSOR_ALIASING_ARM", 1000460000),
    std::make_pair("VK_IMAGE_LAYOUT_VIDEO_ENCODE_QUANTIZATION_MAP_KHR", 1000553000),
    std::make_pair("VK_IMAGE_LAYOUT_ZERO_INITIALIZED_EXT", 1000620000),
};
...
static std::map<std::string, int> VkObjectType_map = {
    ...
    std::make_pair("VK_OBJECT_TYPE_TENSOR_ARM", 1000460000),
    std::make_pair("VK_OBJECT_TYPE_TENSOR_VIEW_ARM", 1000460001),
    std::make_pair("VK_OBJECT_TYPE_OPTICAL_FLOW_SESSION_NV", 1000464000),
    std::make_pair("VK_OBJECT_TYPE_SHADER_EXT", 1000482000),
    std::make_pair("VK_OBJECT_TYPE_PIPELINE_BINARY_KHR", 1000483000),
    std::make_pair("VK_OBJECT_TYPE_SEMAPHORE_SCI_SYNC_POOL_NV", 1000489000),
    std::make_pair("VK_OBJECT_TYPE_DATA_GRAPH_PIPELINE_SESSION_ARM", 1000507000),
    std::make_pair("VK_OBJECT_TYPE_EXTERNAL_COMPUTE_QUEUE_NV", 1000556000),
    std::make_pair("VK_OBJECT_TYPE_INDIRECT_COMMANDS_LAYOUT_EXT", 1000572000),
    std::make_pair("VK_OBJECT_TYPE_INDIRECT_EXECUTION_SET_EXT", 1000572001),
};
...
static std::map<std::string, int> VkVendorId_map = {
    std::make_pair("0", 0),
    std::make_pair("VK_VENDOR_ID_KHRONOS", 0x10000),
    ...
    std::make_pair("VK_VENDOR_ID_MOBILEYE", 0x10007),
};
...
static std::map<std::string, int> VkFormat_map = {
    ...
    std::make_pair("VK_FORMAT_A1B5G5R5_UNORM_PACK16", 1000470000),
    std::make_pair("VK_FORMAT_A8_UNORM", 1000470001),
    ...
    std::make_pair("VK_FORMAT_R8_BOOL_ARM", 1000460000),
    ...
    std::make_pair("VK_FORMAT_R10X6_UINT_PACK16_ARM", 1000609000),
    std::make_pair("VK_FORMAT_R10X6G10X6_UINT_2PACK16_ARM", 1000609001),
    std::make_pair("VK_FORMAT_R10X6G10X6B10X6A10X6_UINT_4PACK16_ARM", 1000609002),
    std::make_pair("VK_FORMAT_R12X4_UINT_PACK16_ARM", 1000609003),
    std::make_pair("VK_FORMAT_R12X4G12X4_UINT_2PACK16_ARM", 1000609004),
    std::make_pair("VK_FORMAT_R12X4G12X4B12X4A12X4_UINT_4PACK16_ARM", 1000609005),
    std::make_pair("VK_FORMAT_R14X2_UINT_PACK16_ARM", 1000609006),
    std::make_pair("VK_FORMAT_R14X2G14X2_UINT_2PACK16_ARM", 1000609007),
    std::make_pair("VK_FORMAT_R14X2G14X2B14X2A14X2_UINT_4PACK16_ARM", 1000609008),
    std::make_pair("VK_FORMAT_R14X2_UNORM_PACK16_ARM", 1000609009),
    std::make_pair("VK_FORMAT_R14X2G14X2_UNORM_2PACK16_ARM", 1000609010),
    std::make_pair("VK_FORMAT_R14X2G14X2B14X2A14X2_UNORM_4PACK16_ARM", 1000609011),
    std::make_pair("VK_FORMAT_G14X2_B14X2R14X2_2PLANE_420_UNORM_3PACK16_ARM", 1000609012),
    std::make_pair("VK_FORMAT_G14X2_B14X2R14X2_2PLANE_422_UNORM_3PACK16_ARM", 1000609013),
};
...
static std::map<std::string, int> VkFormatFeatureFlagBits_map = {
    ...
    std::make_pair("VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_SEPARATE_RECONSTRUCTION_FILTER_BIT_KHR", 1UL << 19),
    std::make_pair("VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_BIT_KHR", 1UL << 20),
    std::make_pair("VK_FORMAT_FEATURE_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_FORCEABLE_BIT_KHR", 1UL << 21),
...
static std::map<std::string, int> VkImageCreateFlagBits_map = {
    ...
    std::make_pair("VK_IMAGE_CREATE_RESERVED_21_BIT_IMG", 1UL << 21),
    ...
    std::make_pair("VK_IMAGE_CREATE_FRAGMENT_DENSITY_MAP_OFFSET_BIT_EXT", 1UL << 15),
    std::make_pair("VK_IMAGE_CREATE_RESERVED_22_BIT_KHR", 1UL << 22),
};
...
static std::map<std::string, int> VkImageUsageFlagBits_map = {
    ...
    std::make_pair("VK_IMAGE_USAGE_HOST_TRANSFER_BIT", 1UL << 22),
    ...
    std::make_pair("VK_IMAGE_USAGE_TENSOR_ALIASING_BIT_ARM", 1UL << 23),
    std::make_pair("VK_IMAGE_USAGE_RESERVED_28_BIT_EXT", 1UL << 28),
    std::make_pair("VK_IMAGE_USAGE_TILE_MEMORY_BIT_QCOM", 1UL << 27),
    std::make_pair("VK_IMAGE_USAGE_VIDEO_ENCODE_QUANTIZATION_DELTA_MAP_BIT_KHR", 1UL << 25),
    std::make_pair("VK_IMAGE_USAGE_VIDEO_ENCODE_EMPHASIS_MAP_BIT_KHR", 1UL << 26),
    std::make_pair("VK_IMAGE_USAGE_RESERVED_29_BIT_KHR", 1UL << 29),
    std::make_pair("VK_IMAGE_USAGE_RESERVED_30_BIT_KHR", 1UL << 30),
};
...
static std::map<std::string, int> VkInstanceCreateFlagBits_map = {
    ...
    std::make_pair("VK_INSTANCE_CREATE_RESERVED_616_BIT_EXT", 1UL << 1),
};
...
static std::map<std::string, int> VkMemoryHeapFlagBits_map = {
    ...
    std::make_pair("VK_MEMORY_HEAP_TILE_MEMORY_BIT_QCOM", 1UL << 3),
};
...
static std::map<std::string, int> VkQueueFlagBits_map = {
    ...
    std::make_pair("VK_QUEUE_RESERVED_7_BIT_QCOM", 1UL << 7),
    std::make_pair("VK_QUEUE_OPTICAL_FLOW_BIT_NV", 1UL << 8),
    std::make_pair("VK_QUEUE_DATA_GRAPH_BIT_ARM", 1UL << 10),
    std::make_pair("VK_QUEUE_RESERVED_12_BIT_EXT", 1UL << 12),
    std::make_pair("VK_QUEUE_RESERVED_13_BIT_EXT", 1UL << 13),
    std::make_pair("VK_QUEUE_RESERVED_11_BIT_ARM", 1UL << 11),
};
...
static std::map<std::string, int> VkDeviceQueueCreateFlagBits_map = {
    ...
    std::make_pair("VK_DEVICE_QUEUE_CREATE_RESERVED_2_BIT_EXT", 1UL << 2),
};
...
static std::map<std::string, int> VkPipelineStageFlagBits_map = {
    ...
    std::make_pair("VK_PIPELINE_STAGE_COMMAND_PREPROCESS_BIT_EXT", 1UL << 17),
};
...
static std::map<std::string, int> VkQueryPoolCreateFlagBits_map = {
    std::make_pair("0", 0),
    std::make_pair("VK_QUERY_POOL_CREATE_RESET_BIT_KHR", 1UL << 0),
};
static void parse_VkQueryPoolCreateFlagBits(const Json::Value& obj, VkQueryPoolCreateFlagBits& o) {
    const std::string& _res = obj.asString();
    o = (VkQueryPoolCreateFlagBits)VkQueryPoolCreateFlagBits_map[std::string(_res)];
}
...
static std::map<std::string, int> VkBufferCreateFlagBits_map = {
    ...
    std::make_pair("VK_BUFFER_CREATE_RESERVED_7_BIT_IMG", 1UL << 7),
...
static std::map<std::string, int> VkBufferUsageFlagBits_map = {
    ...
    std::make_pair("VK_BUFFER_USAGE_TILE_MEMORY_BIT_QCOM", 1UL << 27),
};
...
static std::map<std::string, int> VkDependencyFlagBits_map = {
    ...
    std::make_pair("VK_DEPENDENCY_QUEUE_FAMILY_OWNERSHIP_TRANSFER_USE_ALL_STAGES_BIT_KHR", 1UL << 5),
    std::make_pair("VK_DEPENDENCY_ASYMMETRIC_EVENT_BIT_KHR", 1UL << 6),
...
static std::map<std::string, int> VkIndexType_map = {
    ...
    std::make_pair("VK_INDEX_TYPE_UINT8", 1000265000),
...
static std::map<std::string, int> VkPipelineCacheCreateFlagBits_map = {
    ...
    std::make_pair("VK_PIPELINE_CACHE_CREATE_INTERNALLY_SYNCHRONIZED_MERGE_BIT_KHR", 1UL << 3),
};
...
static std::map<std::string, int> VkPipelineCreateFlagBits_map = {
    ...
    std::make_pair("VK_PIPELINE_CREATE_NO_PROTECTED_ACCESS_BIT", 1UL << 27),
    std::make_pair("VK_PIPELINE_CREATE_PROTECTED_ACCESS_ONLY_BIT", 1UL << 30),
    std::make_pair("VK_PIPELINE_CREATE_VIEW_INDEX_FROM_DEVICE_INDEX_BIT_KHR", 1UL << 3),
    std::make_pair("VK_PIPELINE_CREATE_DISPATCH_BASE_BIT_KHR", 1UL << 4),
    std::make_pair("VK_PIPELINE_CREATE_DISPATCH_BASE_KHR", 1UL << 4),
...
static std::map<std::string, int> VkShaderStageFlagBits_map = {
    ...
    std::make_pair("VK_SHADER_STAGE_RESERVED_15_BIT_NV", 1UL << 15),
};
...
static std::map<std::string, int> VkDescriptorType_map = {
    ...
    std::make_pair("VK_DESCRIPTOR_TYPE_TENSOR_ARM", 1000460000),
    std::make_pair("VK_DESCRIPTOR_TYPE_MUTABLE_EXT", 1000351000),
    std::make_pair("VK_DESCRIPTOR_TYPE_PARTITIONED_ACCELERATION_STRUCTURE_NV", 1000570000),
};
...
static std::map<std::string, int> VkDescriptorSetLayoutCreateFlagBits_map = {
    ...
    std::make_pair("VK_DESCRIPTOR_SET_LAYOUT_CREATE_PUSH_DESCRIPTOR_BIT", 1UL << 0),
...
static std::map<std::string, int> VkPipelineBindPoint_map = {
    ...
    std::make_pair("VK_PIPELINE_BIND_POINT_DATA_GRAPH_ARM", 1000507000),
};
...
static std::map<std::string, int> VkDynamicState_map = {
    ...
    std::make_pair("VK_DYNAMIC_STATE_LINE_STIPPLE", 1000259000),
    ...
    std::make_pair("VK_DYNAMIC_STATE_DEPTH_CLAMP_RANGE_EXT", 1000582000),
};
...
static std::map<std::string, int> VkAttachmentDescriptionFlagBits_map = {
    ...
    std::make_pair("VK_ATTACHMENT_DESCRIPTION_RESOLVE_SKIP_TRANSFER_FUNCTION_BIT_KHR", 1UL << 1),
    std::make_pair("VK_ATTACHMENT_DESCRIPTION_RESOLVE_ENABLE_TRANSFER_FUNCTION_BIT_KHR", 1UL << 2),
};
...
static std::map<std::string, int> VkAttachmentLoadOp_map = {
    ...
    std::make_pair("VK_ATTACHMENT_LOAD_OP_NONE", 1000400000),
...
static std::map<std::string, int> VkRenderPassCreateFlagBits_map = {
    std::make_pair("0", 0),
    std::make_pair("VK_RENDER_PASS_CREATE_RESERVED_3_BIT_IMG", 1UL << 3),
    std::make_pair("VK_RENDER_PASS_CREATE_RESERVED_0_BIT_KHR", 1UL << 0),
    std::make_pair("VK_RENDER_PASS_CREATE_TRANSFORM_BIT_QCOM", 1UL << 1),
    std::make_pair("VK_RENDER_PASS_CREATE_PER_LAYER_FRAGMENT_DENSITY_BIT_VALVE", 1UL << 2),
};
...
static std::map<std::string, int> VkSubpassDescriptionFlagBits_map = {
    ...
    std::make_pair("VK_SUBPASS_DESCRIPTION_TILE_SHADING_APRON_BIT_QCOM", 1UL << 8),
...
static void parse_VkQueryPoolCreateFlags(const Json::Value& obj, VkQueryPoolCreateFlags& o) {
    ...
    for (auto& it : bitmasks) {
        o |= (VkQueryPoolCreateFlagBits)VkQueryPoolCreateFlagBits_map[it];
    }
}
...
static void parse_VkPipelineVertexInputStateCreateFlags(const Json::Value& obj, VkPipelineVertexInputStateCreateFlags& o) {
    if (obj.isString()) {
        const std::string& _res = obj.asString();
        sscanf(_res.c_str(), "%u", &o);
    }
...
static void parse_VkPipelineInputAssemblyStateCreateFlags(const Json::Value& obj, VkPipelineInputAssemblyStateCreateFlags& o) {
    if (obj.isString()) {
        const std::string& _res = obj.asString();
        sscanf(_res.c_str(), "%u", &o);
    }
...
static void parse_VkPipelineTessellationStateCreateFlags(const Json::Value& obj, VkPipelineTessellationStateCreateFlags& o) {
    if (obj.isString()) {
        const std::string& _res = obj.asString();
        sscanf(_res.c_str(), "%u", &o);
    }
...
static void parse_VkPipelineRasterizationStateCreateFlags(const Json::Value& obj, VkPipelineRasterizationStateCreateFlags& o) {
    if (obj.isString()) {
        const std::string& _res = obj.asString();
        sscanf(_res.c_str(), "%u", &o);
    }
...
static void parse_VkPipelineMultisampleStateCreateFlags(const Json::Value& obj, VkPipelineMultisampleStateCreateFlags& o) {
    if (obj.isString()) {
        const std::string& _res = obj.asString();
        sscanf(_res.c_str(), "%u", &o);
    }
...
static void parse_VkPipelineDepthStencilStateCreateFlags(const Json::Value& obj, VkPipelineDepthStencilStateCreateFlags& o) {
    if (obj.isString()) {
        const std::string& _res = obj.asString();
        sscanf(_res.c_str(), "%u", &o);
    }
...
static void parse_VkPhysicalDeviceLimits(const Json::Value& obj, VkPhysicalDeviceLimits& o) {
    ...
    parse_uint32_t(obj["maxTessellationControlPerVertexInputComponents"], (o.maxTessellationControlPerVertexInputComponents));

    parse_uint32_t(obj["maxTessellationControlPerVertexOutputComponents"], (o.maxTessellationControlPerVertexOutputComponents));

    parse_uint32_t(obj["maxTessellationControlPerPatchOutputComponents"], (o.maxTessellationControlPerPatchOutputComponents));
...
static void parse_VkDeviceCreateInfo(const Json::Value& obj, VkDeviceCreateInfo& o) {
    ...
    if (obj_pQueueCreateInfos.size() == 0) (o.pQueueCreateInfos) = nullptr;
        ...
        for (unsigned int i = 0; i < (o.queueCreateInfoCount); i++) {
            parse_VkDeviceQueueCreateInfo(obj_pQueueCreateInfos[i], const_cast<VkDeviceQueueCreateInfo&>((o.pQueueCreateInfos[i])));
        }
    }
...

    {
        ...
        if (obj_pEnabledFeatures.size() == 0) {
            ...
            parse_VkPhysicalDeviceFeatures(obj_pEnabledFeatures, const_cast<VkPhysicalDeviceFeatures&>(*(o.pEnabledFeatures)));
        }
    }
...
static void parse_VkCommandBufferBeginInfo(const Json::Value& obj, VkCommandBufferBeginInfo& o) {
...

    {
        ...
        if (obj_pInheritanceInfo.size() == 0) {
            ...
            parse_VkCommandBufferInheritanceInfo(obj_pInheritanceInfo, const_cast<VkCommandBufferInheritanceInfo&>(*(o.pInheritanceInfo)));
        }
    }
...
static void parse_VkSpecializationInfo(const Json::Value& obj, VkSpecializationInfo& o) {
    ...
    if (obj_pMapEntries.size() == 0) (o.pMapEntries) = nullptr;
        ...
        for (unsigned int i = 0; i < (o.mapEntryCount); i++) {
            parse_VkSpecializationMapEntry(obj_pMapEntries[i], const_cast<VkSpecializationMapEntry&>((o.pMapEntries[i])));
        }
    }
...
static void parse_VkPipelineShaderStageCreateInfo(const Json::Value& obj, VkPipelineShaderStageCreateInfo& o) {
...

    {
        ...
        if (obj_pSpecializationInfo.size() == 0) {
            ...
            parse_VkSpecializationInfo(obj_pSpecializationInfo, const_cast<VkSpecializationInfo&>(*(o.pSpecializationInfo)));
        }
    }
...
static void parse_VkPipelineLayoutCreateInfo(const Json::Value& obj, VkPipelineLayoutCreateInfo& o) {
    ...
    if (obj_pPushConstantRanges.size() == 0) (o.pPushConstantRanges) = nullptr;
        ...
        for (unsigned int i = 0; i < (o.pushConstantRangeCount); i++) {
            parse_VkPushConstantRange(obj_pPushConstantRanges[i], const_cast<VkPushConstantRange&>((o.pPushConstantRanges[i])));
        }
    }
...
static void parse_VkDescriptorSetLayoutCreateInfo(const Json::Value& obj, VkDescriptorSetLayoutCreateInfo& o) {
    ...
    if (obj_pBindings.size() == 0) (o.pBindings) = nullptr;
        ...
        for (unsigned int i = 0; i < (o.bindingCount); i++) {
            parse_VkDescriptorSetLayoutBinding(obj_pBindings[i], const_cast<VkDescriptorSetLayoutBinding&>((o.pBindings[i])));
        }
    }
...
static void parse_VkPipelineVertexInputStateCreateInfo(const Json::Value& obj, VkPipelineVertexInputStateCreateInfo& o) {
    ...
    if (obj_pVertexBindingDescriptions.size() == 0) (o.pVertexBindingDescriptions) = nullptr;
        ...
        for (unsigned int i = 0; i < (o.vertexBindingDescriptionCount); i++) {
            parse_VkVertexInputBindingDescription(obj_pVertexBindingDescriptions[i], const_cast<VkVertexInputBindingDescription&>((o.pVertexBindingDescriptions[i])));
        }
    }
    ...
    if (obj_pVertexAttributeDescriptions.size() == 0) (o.pVertexAttributeDescriptions) = nullptr;
        ...
        for (unsigned int i = 0; i < (o.vertexAttributeDescriptionCount); i++) {
            parse_VkVertexInputAttributeDescription(obj_pVertexAttributeDescriptions[i], const_cast<VkVertexInputAttributeDescription&>((o.pVertexAttributeDescriptions[i])));
        }
    }

}

static void parse_VkPipelineInputAssemblyStateCreateInfo(const Json::Value& obj, VkPipelineInputAssemblyStateCreateInfo& o) {
...
static void parse_VkPipelineTessellationStateCreateInfo(const Json::Value& obj, VkPipelineTessellationStateCreateInfo& o) {
...
static void parse_VkPipelineRasterizationStateCreateInfo(const Json::Value& obj, VkPipelineRasterizationStateCreateInfo& o) {
...
static void parse_VkPipelineDepthStencilStateCreateInfo(const Json::Value& obj, VkPipelineDepthStencilStateCreateInfo& o) {
...
static void parse_VkPipelineColorBlendStateCreateInfo(const Json::Value& obj, VkPipelineColorBlendStateCreateInfo& o) {
    ...
    if (obj_pAttachments.size() == 0) (o.pAttachments) = nullptr;
        ...
        for (unsigned int i = 0; i < (o.attachmentCount); i++) {
            parse_VkPipelineColorBlendAttachmentState(obj_pAttachments[i], const_cast<VkPipelineColorBlendAttachmentState&>((o.pAttachments[i])));
        }
    }
...
static void parse_VkGraphicsPipelineCreateInfo(const Json::Value& obj, VkGraphicsPipelineCreateInfo& o) {
    ...
    if (obj_pStages.size() == 0) (o.pStages) = nullptr;
        ...
        for (unsigned int i = 0; i < (o.stageCount); i++) {
            parse_VkPipelineShaderStageCreateInfo(obj_pStages[i], const_cast<VkPipelineShaderStageCreateInfo&>((o.pStages[i])));
        }
    }

    {
        ...
        if (obj_pVertexInputState.size() == 0) {
            ...
            parse_VkPipelineVertexInputStateCreateInfo(obj_pVertexInputState, const_cast<VkPipelineVertexInputStateCreateInfo&>(*(o.pVertexInputState)));
        }
    }

    {
        ...
        if (obj_pInputAssemblyState.size() == 0) {
            ...
            parse_VkPipelineInputAssemblyStateCreateInfo(obj_pInputAssemblyState, const_cast<VkPipelineInputAssemblyStateCreateInfo&>(*(o.pInputAssemblyState)));
        }
    }

    {
        ...
        if (obj_pTessellationState.size() == 0) {
            ...
            parse_VkPipelineTessellationStateCreateInfo(obj_pTessellationState, const_cast<VkPipelineTessellationStateCreateInfo&>(*(o.pTessellationState)));
        }
    }

    {
        ...
        if (obj_pViewportState.size() == 0) {
            ...
            parse_VkPipelineViewportStateCreateInfo(obj_pViewportState, const_cast<VkPipelineViewportStateCreateInfo&>(*(o.pViewportState)));
        }
    }

    {
        ...
        if (obj_pRasterizationState.size() == 0) {
            ...
            parse_VkPipelineRasterizationStateCreateInfo(obj_pRasterizationState, const_cast<VkPipelineRasterizationStateCreateInfo&>(*(o.pRasterizationState)));
        }
    }

    {
        ...
        if (obj_pMultisampleState.size() == 0) {
            ...
            parse_VkPipelineMultisampleStateCreateInfo(obj_pMultisampleState, const_cast<VkPipelineMultisampleStateCreateInfo&>(*(o.pMultisampleState)));
        }
    }

    {
        ...
        if (obj_pDepthStencilState.size() == 0) {
            ...
            parse_VkPipelineDepthStencilStateCreateInfo(obj_pDepthStencilState, const_cast<VkPipelineDepthStencilStateCreateInfo&>(*(o.pDepthStencilState)));
        }
    }

    {
        ...
        if (obj_pColorBlendState.size() == 0) {
            ...
            parse_VkPipelineColorBlendStateCreateInfo(obj_pColorBlendState, const_cast<VkPipelineColorBlendStateCreateInfo&>(*(o.pColorBlendState)));
        }
    }

    {
        ...
        if (obj_pDynamicState.size() == 0) {
            ...
            parse_VkPipelineDynamicStateCreateInfo(obj_pDynamicState, const_cast<VkPipelineDynamicStateCreateInfo&>(*(o.pDynamicState)));
        }
    }
...
static void parse_VkSubpassDescription(const Json::Value& obj, VkSubpassDescription& o) {
    ...
    if (obj_pInputAttachments.size() == 0) (o.pInputAttachments) = nullptr;
        ...
        for (unsigned int i = 0; i < (o.inputAttachmentCount); i++) {
            parse_VkAttachmentReference(obj_pInputAttachments[i], const_cast<VkAttachmentReference&>((o.pInputAttachments[i])));
        }
    }
    ...
    if (obj_pColorAttachments.size() == 0) (o.pColorAttachments) = nullptr;
        ...
        for (unsigned int i = 0; i < (o.colorAttachmentCount); i++) {
            parse_VkAttachmentReference(obj_pColorAttachments[i], const_cast<VkAttachmentReference&>((o.pColorAttachments[i])));
        }
    }
    ...
    if (obj_pResolveAttachments.size() == 0) (o.pResolveAttachments) = nullptr;
        ...
        for (unsigned int i = 0; i < (o.colorAttachmentCount); i++) {
            parse_VkAttachmentReference(obj_pResolveAttachments[i], const_cast<VkAttachmentReference&>((o.pResolveAttachments[i])));
        }
    }

    {
        ...
        if (obj_pDepthStencilAttachment.size() == 0) {
            ...
            parse_VkAttachmentReference(obj_pDepthStencilAttachment, const_cast<VkAttachmentReference&>(*(o.pDepthStencilAttachment)));
        }
    }
...
static void parse_VkRenderPassCreateInfo(const Json::Value& obj, VkRenderPassCreateInfo& o) {
    ...
    if (obj_pAttachments.size() == 0) (o.pAttachments) = nullptr;
        ...
        for (unsigned int i = 0; i < (o.attachmentCount); i++) {
            parse_VkAttachmentDescription(obj_pAttachments[i], const_cast<VkAttachmentDescription&>((o.pAttachments[i])));
        }
    }
...
static std::map<std::string, int> VkMemoryAllocateFlagBits_map = {
    ...
    std::make_pair("VK_MEMORY_ALLOCATE_ZERO_INITIALIZE_BIT_EXT", 1UL << 3),
};
...
static std::map<std::string, int> VkExternalMemoryHandleTypeFlagBits_map = {
    ...
    std::make_pair("VK_EXTERNAL_MEMORY_HANDLE_TYPE_MTLBUFFER_BIT_EXT", 1UL << 16),
    std::make_pair("VK_EXTERNAL_MEMORY_HANDLE_TYPE_MTLTEXTURE_BIT_EXT", 1UL << 17),
    std::make_pair("VK_EXTERNAL_MEMORY_HANDLE_TYPE_MTLHEAP_BIT_EXT", 1UL << 18),
};
...
static void parse_VkExternalSemaphoreHandleTypeFlagBits(const Json::Value& obj, VkExternalSemaphoreHandleTypeFlagBits& o) {
    const std::string& _res = obj.asString();
...
static std::map<std::string, int> VkSubgroupFeatureFlagBits_map = {
    ...
    std::make_pair("VK_SUBGROUP_FEATURE_ROTATE_BIT", 1UL << 9),
    std::make_pair("VK_SUBGROUP_FEATURE_ROTATE_CLUSTERED_BIT", 1UL << 10),
...
static void parse_VkPhysicalDeviceProtectedMemoryFeatures(const Json::Value& obj, VkPhysicalDeviceProtectedMemoryFeatures& o) {
...
static void parse_VkPhysicalDeviceProtectedMemoryProperties(const Json::Value& obj, VkPhysicalDeviceProtectedMemoryProperties& o) {
...
static void parse_VkPhysicalDeviceExternalImageFormatInfo(const Json::Value& obj, VkPhysicalDeviceExternalImageFormatInfo& o) {
...
static void parse_VkPhysicalDeviceExternalSemaphoreInfo(const Json::Value& obj, VkPhysicalDeviceExternalSemaphoreInfo& o) {
...
static void parse_VkPhysicalDeviceVariablePointersFeatures(const Json::Value& obj, VkPhysicalDeviceVariablePointersFeatures& o) {
...
static void parse_VkPhysicalDeviceMaintenance3Properties(const Json::Value& obj, VkPhysicalDeviceMaintenance3Properties& o) {
...
static void parse_VkPhysicalDeviceSamplerYcbcrConversionFeatures(const Json::Value& obj, VkPhysicalDeviceSamplerYcbcrConversionFeatures& o) {
...
static void parse_VkSamplerYcbcrConversionImageFormatProperties(const Json::Value& obj, VkSamplerYcbcrConversionImageFormatProperties& o) {
...
static void parse_VkPhysicalDevicePointClippingProperties(const Json::Value& obj, VkPhysicalDevicePointClippingProperties& o) {
...
static void parse_VkRenderPassInputAttachmentAspectCreateInfo(const Json::Value& obj, VkRenderPassInputAttachmentAspectCreateInfo& o) {
    ...
    if (obj_pAspectReferences.size() == 0) (o.pAspectReferences) = nullptr;
        ...
        for (unsigned int i = 0; i < (o.aspectReferenceCount); i++) {
            parse_VkInputAttachmentAspectReference(obj_pAspectReferences[i], const_cast<VkInputAttachmentAspectReference&>((o.pAspectReferences[i])));
        }
    }

}

static void parse_VkPipelineTessellationDomainOriginStateCreateInfo(const Json::Value& obj, VkPipelineTessellationDomainOriginStateCreateInfo& o) {
...
static void parse_VkPhysicalDeviceShaderDrawParametersFeatures(const Json::Value& obj, VkPhysicalDeviceShaderDrawParametersFeatures& o) {
...
static std::map<std::string, int> VkDriverId_map = {
    ...
    std::make_pair("VK_DRIVER_ID_VULKAN_SC_EMULATION_ON_VULKAN", 27),
    std::make_pair("VK_DRIVER_ID_MESA_KOSMICKRISP", 28),
...
static std::map<std::string, int> VkResolveModeFlagBits_map = {
    ...
    std::make_pair("VK_RESOLVE_MODE_EXTERNAL_FORMAT_DOWNSAMPLE_BIT_ANDROID", 1UL << 4),
    std::make_pair("VK_RESOLVE_MODE_EXTERNAL_FORMAT_DOWNSAMPLE_ANDROID", 1UL << 4),
    std::make_pair("VK_RESOLVE_MODE_RESERVED_5_BIT_EXT", 1UL << 5),
};
...
static void parse_VkPhysicalDeviceVulkan12Features(const Json::Value& obj, VkPhysicalDeviceVulkan12Features& o) {
    ...
    parse_VkBool32(obj["shaderUniformTexelBufferArrayDynamicIndexing"], (o.shaderUniformTexelBufferArrayDynamicIndexing));

    parse_VkBool32(obj["shaderStorageTexelBufferArrayDynamicIndexing"], (o.shaderStorageTexelBufferArrayDynamicIndexing));
    ...
    parse_VkBool32(obj["shaderInputAttachmentArrayNonUniformIndexing"], (o.shaderInputAttachmentArrayNonUniformIndexing));

    parse_VkBool32(obj["shaderUniformTexelBufferArrayNonUniformIndexing"], (o.shaderUniformTexelBufferArrayNonUniformIndexing));

    parse_VkBool32(obj["shaderStorageTexelBufferArrayNonUniformIndexing"], (o.shaderStorageTexelBufferArrayNonUniformIndexing));

    parse_VkBool32(obj["descriptorBindingUniformBufferUpdateAfterBind"], (o.descriptorBindingUniformBufferUpdateAfterBind));

    parse_VkBool32(obj["descriptorBindingSampledImageUpdateAfterBind"], (o.descriptorBindingSampledImageUpdateAfterBind));

    parse_VkBool32(obj["descriptorBindingStorageImageUpdateAfterBind"], (o.descriptorBindingStorageImageUpdateAfterBind));

    parse_VkBool32(obj["descriptorBindingStorageBufferUpdateAfterBind"], (o.descriptorBindingStorageBufferUpdateAfterBind));

    parse_VkBool32(obj["descriptorBindingUniformTexelBufferUpdateAfterBind"], (o.descriptorBindingUniformTexelBufferUpdateAfterBind));

    parse_VkBool32(obj["descriptorBindingStorageTexelBufferUpdateAfterBind"], (o.descriptorBindingStorageTexelBufferUpdateAfterBind));
    ...
    parse_VkBool32(obj["vulkanMemoryModelAvailabilityVisibilityChains"], (o.vulkanMemoryModelAvailabilityVisibilityChains));
...
static void parse_VkPhysicalDeviceVulkan12Properties(const Json::Value& obj, VkPhysicalDeviceVulkan12Properties& o) {
    ...
    parse_VkBool32(obj["shaderUniformBufferArrayNonUniformIndexingNative"], (o.shaderUniformBufferArrayNonUniformIndexingNative));

    parse_VkBool32(obj["shaderSampledImageArrayNonUniformIndexingNative"], (o.shaderSampledImageArrayNonUniformIndexingNative));

    parse_VkBool32(obj["shaderStorageBufferArrayNonUniformIndexingNative"], (o.shaderStorageBufferArrayNonUniformIndexingNative));

    parse_VkBool32(obj["shaderStorageImageArrayNonUniformIndexingNative"], (o.shaderStorageImageArrayNonUniformIndexingNative));

    parse_VkBool32(obj["shaderInputAttachmentArrayNonUniformIndexingNative"], (o.shaderInputAttachmentArrayNonUniformIndexingNative));
    ...
    parse_uint32_t(obj["maxPerStageDescriptorUpdateAfterBindSamplers"], (o.maxPerStageDescriptorUpdateAfterBindSamplers));

    parse_uint32_t(obj["maxPerStageDescriptorUpdateAfterBindUniformBuffers"], (o.maxPerStageDescriptorUpdateAfterBindUniformBuffers));

    parse_uint32_t(obj["maxPerStageDescriptorUpdateAfterBindStorageBuffers"], (o.maxPerStageDescriptorUpdateAfterBindStorageBuffers));

    parse_uint32_t(obj["maxPerStageDescriptorUpdateAfterBindSampledImages"], (o.maxPerStageDescriptorUpdateAfterBindSampledImages));

    parse_uint32_t(obj["maxPerStageDescriptorUpdateAfterBindStorageImages"], (o.maxPerStageDescriptorUpdateAfterBindStorageImages));

    parse_uint32_t(obj["maxPerStageDescriptorUpdateAfterBindInputAttachments"], (o.maxPerStageDescriptorUpdateAfterBindInputAttachments));
    ...
    parse_uint32_t(obj["maxDescriptorSetUpdateAfterBindUniformBuffers"], (o.maxDescriptorSetUpdateAfterBindUniformBuffers));

    parse_uint32_t(obj["maxDescriptorSetUpdateAfterBindUniformBuffersDynamic"], (o.maxDescriptorSetUpdateAfterBindUniformBuffersDynamic));

    parse_uint32_t(obj["maxDescriptorSetUpdateAfterBindStorageBuffers"], (o.maxDescriptorSetUpdateAfterBindStorageBuffers));

    parse_uint32_t(obj["maxDescriptorSetUpdateAfterBindStorageBuffersDynamic"], (o.maxDescriptorSetUpdateAfterBindStorageBuffersDynamic));

    parse_uint32_t(obj["maxDescriptorSetUpdateAfterBindSampledImages"], (o.maxDescriptorSetUpdateAfterBindSampledImages));

    parse_uint32_t(obj["maxDescriptorSetUpdateAfterBindStorageImages"], (o.maxDescriptorSetUpdateAfterBindStorageImages));

    parse_uint32_t(obj["maxDescriptorSetUpdateAfterBindInputAttachments"], (o.maxDescriptorSetUpdateAfterBindInputAttachments));
...
static void parse_VkPhysicalDeviceVulkanMemoryModelFeatures(const Json::Value& obj, VkPhysicalDeviceVulkanMemoryModelFeatures& o) {
...
static void parse_VkPhysicalDeviceHostQueryResetFeatures(const Json::Value& obj, VkPhysicalDeviceHostQueryResetFeatures& o) {
...
static void parse_VkPhysicalDeviceTimelineSemaphoreFeatures(const Json::Value& obj, VkPhysicalDeviceTimelineSemaphoreFeatures& o) {
...
static void parse_VkPhysicalDeviceTimelineSemaphoreProperties(const Json::Value& obj, VkPhysicalDeviceTimelineSemaphoreProperties& o) {
...
static void parse_VkPhysicalDeviceBufferDeviceAddressFeatures(const Json::Value& obj, VkPhysicalDeviceBufferDeviceAddressFeatures& o) {
...
static void parse_VkMemoryOpaqueCaptureAddressAllocateInfo(const Json::Value& obj, VkMemoryOpaqueCaptureAddressAllocateInfo& o) {
...
static void parse_VkDeviceMemoryOpaqueCaptureAddressInfo(const Json::Value& obj, VkDeviceMemoryOpaqueCaptureAddressInfo& o) {
...
static void parse_VkPhysicalDeviceShaderAtomicInt64Features(const Json::Value& obj, VkPhysicalDeviceShaderAtomicInt64Features& o) {
...
static void parse_VkPhysicalDeviceShaderFloat16Int8Features(const Json::Value& obj, VkPhysicalDeviceShaderFloat16Int8Features& o) {
...
static void parse_VkPhysicalDeviceFloatControlsProperties(const Json::Value& obj, VkPhysicalDeviceFloatControlsProperties& o) {
...
static void parse_VkDescriptorSetLayoutBindingFlagsCreateInfo(const Json::Value& obj, VkDescriptorSetLayoutBindingFlagsCreateInfo& o) {
...
static void parse_VkPhysicalDeviceDescriptorIndexingFeatures(const Json::Value& obj, VkPhysicalDeviceDescriptorIndexingFeatures& o) {
...
static void parse_VkPhysicalDeviceDescriptorIndexingProperties(const Json::Value& obj, VkPhysicalDeviceDescriptorIndexingProperties& o) {
...
static void parse_VkDescriptorSetVariableDescriptorCountAllocateInfo(const Json::Value& obj, VkDescriptorSetVariableDescriptorCountAllocateInfo& o) {
...
static void parse_VkDescriptorSetVariableDescriptorCountLayoutSupport(const Json::Value& obj, VkDescriptorSetVariableDescriptorCountLayoutSupport& o) {
...
static void parse_VkPhysicalDeviceScalarBlockLayoutFeatures(const Json::Value& obj, VkPhysicalDeviceScalarBlockLayoutFeatures& o) {
...
static void parse_VkPhysicalDeviceSamplerFilterMinmaxProperties(const Json::Value& obj, VkPhysicalDeviceSamplerFilterMinmaxProperties& o) {
...
static void parse_VkPhysicalDeviceUniformBufferStandardLayoutFeatures(const Json::Value& obj, VkPhysicalDeviceUniformBufferStandardLayoutFeatures& o) {
...
static void parse_VkPhysicalDeviceShaderSubgroupExtendedTypesFeatures(const Json::Value& obj, VkPhysicalDeviceShaderSubgroupExtendedTypesFeatures& o) {
...
static void parse_VkSubpassDescription2(const Json::Value& obj, VkSubpassDescription2& o) {
    ...
    if (obj_pInputAttachments.size() == 0) (o.pInputAttachments) = nullptr;
        ...
        for (unsigned int i = 0; i < (o.inputAttachmentCount); i++) {
            parse_VkAttachmentReference2(obj_pInputAttachments[i], const_cast<VkAttachmentReference2&>((o.pInputAttachments[i])));
        }
    }
    ...
    if (obj_pColorAttachments.size() == 0) (o.pColorAttachments) = nullptr;
        ...
        for (unsigned int i = 0; i < (o.colorAttachmentCount); i++) {
            parse_VkAttachmentReference2(obj_pColorAttachments[i], const_cast<VkAttachmentReference2&>((o.pColorAttachments[i])));
        }
    }
    ...
    if (obj_pResolveAttachments.size() == 0) (o.pResolveAttachments) = nullptr;
        ...
        for (unsigned int i = 0; i < (o.colorAttachmentCount); i++) {
            parse_VkAttachmentReference2(obj_pResolveAttachments[i], const_cast<VkAttachmentReference2&>((o.pResolveAttachments[i])));
        }
    }

    {
        ...
        if (obj_pDepthStencilAttachment.size() == 0) {
            ...
            parse_VkAttachmentReference2(obj_pDepthStencilAttachment, const_cast<VkAttachmentReference2&>(*(o.pDepthStencilAttachment)));
        }
    }
...
static void parse_VkRenderPassCreateInfo2(const Json::Value& obj, VkRenderPassCreateInfo2& o) {
    ...
    if (obj_pAttachments.size() == 0) (o.pAttachments) = nullptr;
        ...
        for (unsigned int i = 0; i < (o.attachmentCount); i++) {
            parse_VkAttachmentDescription2(obj_pAttachments[i], const_cast<VkAttachmentDescription2&>((o.pAttachments[i])));
        }
    }
...
static void parse_VkSubpassDescriptionDepthStencilResolve(const Json::Value& obj, VkSubpassDescriptionDepthStencilResolve& o) {
...

    {
        ...
        if (obj_pDepthStencilResolveAttachment.size() == 0) {
            ...
            parse_VkAttachmentReference2(obj_pDepthStencilResolveAttachment, const_cast<VkAttachmentReference2&>(*(o.pDepthStencilResolveAttachment)));
        }
    }

}

static void parse_VkPhysicalDeviceDepthStencilResolveProperties(const Json::Value& obj, VkPhysicalDeviceDepthStencilResolveProperties& o) {
...
static void parse_VkPhysicalDeviceImagelessFramebufferFeatures(const Json::Value& obj, VkPhysicalDeviceImagelessFramebufferFeatures& o) {
...
static void parse_VkFramebufferAttachmentsCreateInfo(const Json::Value& obj, VkFramebufferAttachmentsCreateInfo& o) {
    ...
    if (obj_pAttachmentImageInfos.size() == 0) (o.pAttachmentImageInfos) = nullptr;
        ...
        for (unsigned int i = 0; i < (o.attachmentImageInfoCount); i++) {
            parse_VkFramebufferAttachmentImageInfo(obj_pAttachmentImageInfos[i], const_cast<VkFramebufferAttachmentImageInfo&>((o.pAttachmentImageInfos[i])));
        }
    }
...
static void parse_VkPhysicalDeviceSeparateDepthStencilLayoutsFeatures(const Json::Value& obj, VkPhysicalDeviceSeparateDepthStencilLayoutsFeatures& o) {
...
static void parse_VkPhysicalDeviceVulkanSC10Properties(const Json::Value& obj, VkPhysicalDeviceVulkanSC10Properties& o) {
    ...
    parse_VkBool32(obj["secondaryCommandBufferNullOrImagelessFramebuffer"], (o.secondaryCommandBufferNullOrImagelessFramebuffer));
...
static void parse_VkDeviceObjectReservationCreateInfo(const Json::Value& obj, VkDeviceObjectReservationCreateInfo& o) {
    ...
    if (obj_pPipelineCacheCreateInfos.size() == 0) (o.pPipelineCacheCreateInfos) = nullptr;
        ...
        for (unsigned int i = 0; i < (o.pipelineCacheCreateInfoCount); i++) {
            parse_VkPipelineCacheCreateInfo(obj_pPipelineCacheCreateInfos[i], const_cast<VkPipelineCacheCreateInfo&>((o.pPipelineCacheCreateInfos[i])));
        }
    }
    ...
    if (obj_pPipelinePoolSizes.size() == 0) (o.pPipelinePoolSizes) = nullptr;
        ...
        for (unsigned int i = 0; i < (o.pipelinePoolSizeCount); i++) {
            parse_VkPipelinePoolSize(obj_pPipelinePoolSizes[i], const_cast<VkPipelinePoolSize&>((o.pPipelinePoolSizes[i])));
        }
    }
...
static void parse_VkCommandPoolMemoryReservationCreateInfo(const Json::Value& obj, VkCommandPoolMemoryReservationCreateInfo& o) {
...
static void parse_VkPipelineCacheStageValidationIndexEntry(const Json::Value& obj, VkPipelineCacheStageValidationIndexEntry& o) {
...
static void parse_VkPipelineCacheHeaderVersionSafetyCriticalOne(const Json::Value& obj, VkPipelineCacheHeaderVersionSafetyCriticalOne& o) {
...
static std::map<std::string, int> VkPresentModeKHR_map = {
    ...
    std::make_pair("VK_PRESENT_MODE_FIFO_LATEST_READY_EXT", 1000361000),
    std::make_pair("VK_PRESENT_MODE_FIFO_LATEST_READY_KHR", 1000361000),
};
...
static std::map<std::string, int> VkSwapchainCreateFlagBitsKHR_map = {
    ...
    std::make_pair("VK_SWAPCHAIN_CREATE_RESERVED_9_BIT_EXT", 1UL << 9),
    std::make_pair("VK_SWAPCHAIN_CREATE_DEFERRED_MEMORY_ALLOCATION_BIT_EXT", 1UL << 3),
    std::make_pair("VK_SWAPCHAIN_CREATE_RESERVED_5_BIT_EXT", 1UL << 5),
    std::make_pair("VK_SWAPCHAIN_CREATE_RESERVED_4_BIT_EXT", 1UL << 4),
    std::make_pair("VK_SWAPCHAIN_CREATE_PRESENT_ID_2_BIT_KHR", 1UL << 6),
    std::make_pair("VK_SWAPCHAIN_CREATE_PRESENT_WAIT_2_BIT_KHR", 1UL << 7),
    std::make_pair("VK_SWAPCHAIN_CREATE_DEFERRED_MEMORY_ALLOCATION_BIT_KHR", 1UL << 3),
    std::make_pair("VK_SWAPCHAIN_CREATE_RESERVED_8_BIT_EXT", 1UL << 8),
};
...
static void parse_VkSharedPresentSurfaceCapabilitiesKHR(const Json::Value& obj, VkSharedPresentSurfaceCapabilitiesKHR& o) {
...
static void parse_VkPerformanceCounterDescriptionFlagBitsKHR(const Json::Value& obj, VkPerformanceCounterDescriptionFlagBitsKHR& o) {
    const std::string& _res = obj.asString();
...
static void parse_VkPerformanceCounterDescriptionFlagsKHR(const Json::Value& obj, VkPerformanceCounterDescriptionFlagsKHR& o) {
...
static void parse_VkPhysicalDevicePerformanceQueryFeaturesKHR(const Json::Value& obj, VkPhysicalDevicePerformanceQueryFeaturesKHR& o) {
...
static void parse_VkPhysicalDevicePerformanceQueryPropertiesKHR(const Json::Value& obj, VkPhysicalDevicePerformanceQueryPropertiesKHR& o) {
...
static void parse_VkPhysicalDeviceShaderClockFeaturesKHR(const Json::Value& obj, VkPhysicalDeviceShaderClockFeaturesKHR& o) {
...
static void parse_VkDeviceQueueGlobalPriorityCreateInfo(const Json::Value& obj, VkDeviceQueueGlobalPriorityCreateInfo& o) {

    parse_VkStructureType(obj["sType"], (o.sType));

    o.pNext = (VkDeviceQueueGlobalPriorityCreateInfo*)parsePNextChain(obj);

    parse_VkQueueGlobalPriority(obj["globalPriority"], (o.globalPriority));

}

static void parse_VkPhysicalDeviceGlobalPriorityQueryFeatures(const Json::Value& obj, VkPhysicalDeviceGlobalPriorityQueryFeatures& o) {

    parse_VkStructureType(obj["sType"], (o.sType));

    o.pNext = (VkPhysicalDeviceGlobalPriorityQueryFeatures*)parsePNextChain(obj);

    parse_VkBool32(obj["globalPriorityQuery"], (o.globalPriorityQuery));

}

static void parse_VkQueueFamilyGlobalPriorityProperties(const Json::Value& obj, VkQueueFamilyGlobalPriorityProperties& o) {

    parse_VkStructureType(obj["sType"], (o.sType));

    o.pNext = (VkQueueFamilyGlobalPriorityProperties*)parsePNextChain(obj);
...
static void parse_VkPhysicalDeviceShaderTerminateInvocationFeatures(const Json::Value& obj, VkPhysicalDeviceShaderTerminateInvocationFeatures& o) {
...
static void parse_VkFragmentShadingRateAttachmentInfoKHR(const Json::Value& obj, VkFragmentShadingRateAttachmentInfoKHR& o) {
...

    {
        ...
        if (obj_pFragmentShadingRateAttachment.size() == 0) {
            ...
            parse_VkAttachmentReference2(obj_pFragmentShadingRateAttachment, const_cast<VkAttachmentReference2&>(*(o.pFragmentShadingRateAttachment)));
        }
    }
...
static void parse_VkPipelineFragmentShadingRateStateCreateInfoKHR(const Json::Value& obj, VkPipelineFragmentShadingRateStateCreateInfoKHR& o) {
    ...
    for (unsigned int i = 0; i < obj_combinerOps_arr.size(); i++) {
        parse_VkFragmentShadingRateCombinerOpKHR(obj_combinerOps_arr[i], const_cast<VkFragmentShadingRateCombinerOpKHR&>((o.combinerOps[i])));
    }

}

static void parse_VkPhysicalDeviceFragmentShadingRateFeaturesKHR(const Json::Value& obj, VkPhysicalDeviceFragmentShadingRateFeaturesKHR& o) {
...
static void parse_VkPhysicalDeviceFragmentShadingRatePropertiesKHR(const Json::Value& obj, VkPhysicalDeviceFragmentShadingRatePropertiesKHR& o) {
    ...
    parse_uint32_t(obj["maxFragmentShadingRateAttachmentTexelSizeAspectRatio"], (o.maxFragmentShadingRateAttachmentTexelSizeAspectRatio));

    parse_VkBool32(obj["primitiveFragmentShadingRateWithMultipleViewports"], (o.primitiveFragmentShadingRateWithMultipleViewports));
    ...
    parse_VkSampleCountFlagBits(obj["maxFragmentShadingRateRasterizationSamples"], (o.maxFragmentShadingRateRasterizationSamples));

    parse_VkBool32(obj["fragmentShadingRateWithShaderDepthStencilWrites"], (o.fragmentShadingRateWithShaderDepthStencilWrites));
    ...
    parse_VkBool32(obj["fragmentShadingRateWithConservativeRasterization"], (o.fragmentShadingRateWithConservativeRasterization));

    parse_VkBool32(obj["fragmentShadingRateWithFragmentShaderInterlock"], (o.fragmentShadingRateWithFragmentShaderInterlock));

    parse_VkBool32(obj["fragmentShadingRateWithCustomSampleLocations"], (o.fragmentShadingRateWithCustomSampleLocations));

    parse_VkBool32(obj["fragmentShadingRateStrictMultiplyCombiner"], (o.fragmentShadingRateStrictMultiplyCombiner));

}

static void parse_VkPhysicalDeviceFragmentShadingRateKHR(const Json::Value& obj, VkPhysicalDeviceFragmentShadingRateKHR& o) {
...
static std::map<std::string, uint64_t> VkPipelineStageFlagBits2_map = {
    ...
    std::make_pair("VK_PIPELINE_STAGE_2_TRANSFER_BIT", 1ULL << 12),
    ...
    std::make_pair("VK_PIPELINE_STAGE_2_COMMAND_PREPROCESS_BIT_EXT", 1ULL << 17),
    ...
    std::make_pair("VK_PIPELINE_STAGE_2_CONVERT_COOPERATIVE_VECTOR_MATRIX_BIT_NV", 1ULL << 44),
    std::make_pair("VK_PIPELINE_STAGE_2_DATA_GRAPH_BIT_ARM", 1ULL << 42),
    std::make_pair("VK_PIPELINE_STAGE_2_COPY_INDIRECT_BIT_KHR", 1ULL << 46),
    std::make_pair("VK_PIPELINE_STAGE_2_MEMORY_DECOMPRESSION_BIT_EXT", 1ULL << 45),
    std::make_pair("VK_PIPELINE_STAGE_2_RESERVED_47_BIT_KHR", 1ULL << 47),
...
static std::map<std::string, uint64_t> VkAccessFlagBits2_map = {
    ...
    std::make_pair("VK_ACCESS_2_SHADER_TILE_ATTACHMENT_READ_BIT_QCOM", 1ULL << 51),
    std::make_pair("VK_ACCESS_2_SHADER_TILE_ATTACHMENT_WRITE_BIT_QCOM", 1ULL << 52),
    ...
    std::make_pair("VK_ACCESS_2_COMMAND_PREPROCESS_READ_BIT_EXT", 1ULL << 17),
    std::make_pair("VK_ACCESS_2_COMMAND_PREPROCESS_WRITE_BIT_EXT", 1ULL << 18),
    ...
    std::make_pair("VK_ACCESS_2_DATA_GRAPH_READ_BIT_ARM", 1ULL << 47),
    std::make_pair("VK_ACCESS_2_DATA_GRAPH_WRITE_BIT_ARM", 1ULL << 48),
    std::make_pair("VK_ACCESS_2_MEMORY_DECOMPRESSION_READ_BIT_EXT", 1ULL << 55),
    std::make_pair("VK_ACCESS_2_MEMORY_DECOMPRESSION_WRITE_BIT_EXT", 1ULL << 56),
    std::make_pair("VK_ACCESS_2_RESERVED_60_BIT_KHR", 1ULL << 60),
    std::make_pair("VK_ACCESS_2_RESERVED_61_BIT_KHR", 1ULL << 61),
...
static void parse_VkDependencyInfo(const Json::Value& obj, VkDependencyInfo& o) {
    ...
    (o.pBufferMemoryBarriers) = (VkBufferMemoryBarrier2*)s_globalMem.allocate((o.bufferMemoryBarrierCount), sizeof(VkBufferMemoryBarrier2));
    ...
    if (obj_pBufferMemoryBarriers.size() == 0) (o.pBufferMemoryBarriers) = nullptr;
        ...
        for (unsigned int i = 0; i < (o.bufferMemoryBarrierCount); i++) {
            parse_VkBufferMemoryBarrier2(obj_pBufferMemoryBarriers[i], const_cast<VkBufferMemoryBarrier2&>((o.pBufferMemoryBarriers[i])));
        }
    }

    parse_uint32_t(obj["imageMemoryBarrierCount"], (o.imageMemoryBarrierCount));

    (o.pImageMemoryBarriers) = (VkImageMemoryBarrier2*)s_globalMem.allocate((o.imageMemoryBarrierCount), sizeof(VkImageMemoryBarrier2));
    ...
    if (obj_pImageMemoryBarriers.size() == 0) (o.pImageMemoryBarriers) = nullptr;
        ...
        for (unsigned int i = 0; i < (o.imageMemoryBarrierCount); i++) {
            parse_VkImageMemoryBarrier2(obj_pImageMemoryBarriers[i], const_cast<VkImageMemoryBarrier2&>((o.pImageMemoryBarriers[i])));
        }
    }
...
static void parse_VkSubmitInfo2(const Json::Value& obj, VkSubmitInfo2& o) {
    ...
    (o.pWaitSemaphoreInfos) = (VkSemaphoreSubmitInfo*)s_globalMem.allocate((o.waitSemaphoreInfoCount), sizeof(VkSemaphoreSubmitInfo));
    ...
    if (obj_pWaitSemaphoreInfos.size() == 0) (o.pWaitSemaphoreInfos) = nullptr;
        ...
        for (unsigned int i = 0; i < (o.waitSemaphoreInfoCount); i++) {
            parse_VkSemaphoreSubmitInfo(obj_pWaitSemaphoreInfos[i], const_cast<VkSemaphoreSubmitInfo&>((o.pWaitSemaphoreInfos[i])));
        }
    }

    parse_uint32_t(obj["commandBufferInfoCount"], (o.commandBufferInfoCount));

    (o.pCommandBufferInfos) = (VkCommandBufferSubmitInfo*)s_globalMem.allocate((o.commandBufferInfoCount), sizeof(VkCommandBufferSubmitInfo));
    ...
    if (obj_pCommandBufferInfos.size() == 0) (o.pCommandBufferInfos) = nullptr;
        ...
        for (unsigned int i = 0; i < (o.commandBufferInfoCount); i++) {
            parse_VkCommandBufferSubmitInfo(obj_pCommandBufferInfos[i], const_cast<VkCommandBufferSubmitInfo&>((o.pCommandBufferInfos[i])));
        }
    }

    parse_uint32_t(obj["signalSemaphoreInfoCount"], (o.signalSemaphoreInfoCount));

    (o.pSignalSemaphoreInfos) = (VkSemaphoreSubmitInfo*)s_globalMem.allocate((o.signalSemaphoreInfoCount), sizeof(VkSemaphoreSubmitInfo));
    ...
    if (obj_pSignalSemaphoreInfos.size() == 0) (o.pSignalSemaphoreInfos) = nullptr;
        ...
        for (unsigned int i = 0; i < (o.signalSemaphoreInfoCount); i++) {
            parse_VkSemaphoreSubmitInfo(obj_pSignalSemaphoreInfos[i], const_cast<VkSemaphoreSubmitInfo&>((o.pSignalSemaphoreInfos[i])));
        }
    }

}

static void parse_VkPhysicalDeviceSynchronization2Features(const Json::Value& obj, VkPhysicalDeviceSynchronization2Features& o) {
...
static void parse_VkPhysicalDeviceVertexAttributeDivisorProperties(const Json::Value& obj, VkPhysicalDeviceVertexAttributeDivisorProperties& o) {

    parse_VkStructureType(obj["sType"], (o.sType));

    o.pNext = (VkPhysicalDeviceVertexAttributeDivisorProperties*)parsePNextChain(obj);
...
static void parse_VkVertexInputBindingDivisorDescription(const Json::Value& obj, VkVertexInputBindingDivisorDescription& o) {
...
static void parse_VkPipelineVertexInputDivisorStateCreateInfo(const Json::Value& obj, VkPipelineVertexInputDivisorStateCreateInfo& o) {

    parse_VkStructureType(obj["sType"], (o.sType));

    o.pNext = (VkPipelineVertexInputDivisorStateCreateInfo*)parsePNextChain(obj);

    parse_uint32_t(obj["vertexBindingDivisorCount"], (o.vertexBindingDivisorCount));

    (o.pVertexBindingDivisors) = (VkVertexInputBindingDivisorDescription*)s_globalMem.allocate((o.vertexBindingDivisorCount), sizeof(VkVertexInputBindingDivisorDescription));
    ...
    if (obj_pVertexBindingDivisors.size() == 0) (o.pVertexBindingDivisors) = nullptr;
        ...
        for (unsigned int i = 0; i < (o.vertexBindingDivisorCount); i++) {
            parse_VkVertexInputBindingDivisorDescription(obj_pVertexBindingDivisors[i], const_cast<VkVertexInputBindingDivisorDescription&>((o.pVertexBindingDivisors[i])));
        }
    }

}

static void parse_VkPhysicalDeviceVertexAttributeDivisorFeatures(const Json::Value& obj, VkPhysicalDeviceVertexAttributeDivisorFeatures& o) {

    parse_VkStructureType(obj["sType"], (o.sType));

    o.pNext = (VkPhysicalDeviceVertexAttributeDivisorFeatures*)parsePNextChain(obj);
...
static void parse_VkPhysicalDeviceIndexTypeUint8Features(const Json::Value& obj, VkPhysicalDeviceIndexTypeUint8Features& o) {

    parse_VkStructureType(obj["sType"], (o.sType));

    o.pNext = (VkPhysicalDeviceIndexTypeUint8Features*)parsePNextChain(obj);
...
static void parse_VkPhysicalDeviceLineRasterizationFeatures(const Json::Value& obj, VkPhysicalDeviceLineRasterizationFeatures& o) {

    parse_VkStructureType(obj["sType"], (o.sType));

    o.pNext = (VkPhysicalDeviceLineRasterizationFeatures*)parsePNextChain(obj);
...
static void parse_VkPhysicalDeviceLineRasterizationProperties(const Json::Value& obj, VkPhysicalDeviceLineRasterizationProperties& o) {

    parse_VkStructureType(obj["sType"], (o.sType));

    o.pNext = (VkPhysicalDeviceLineRasterizationProperties*)parsePNextChain(obj);

    parse_uint32_t(obj["lineSubPixelPrecisionBits"], (o.lineSubPixelPrecisionBits));

}

static void parse_VkPipelineRasterizationLineStateCreateInfo(const Json::Value& obj, VkPipelineRasterizationLineStateCreateInfo& o) {

    parse_VkStructureType(obj["sType"], (o.sType));

    o.pNext = (VkPipelineRasterizationLineStateCreateInfo*)parsePNextChain(obj);
...
static void parse_VkPhysicalDeviceTextureCompressionASTCHDRFeatures(const Json::Value& obj, VkPhysicalDeviceTextureCompressionASTCHDRFeatures& o) {
...
static void parse_VkPhysicalDeviceASTCDecodeFeaturesEXT(const Json::Value& obj, VkPhysicalDeviceASTCDecodeFeaturesEXT& o) {
...
static void parse_VkPipelineDiscardRectangleStateCreateFlagsEXT(const Json::Value& obj, VkPipelineDiscardRectangleStateCreateFlagsEXT& o) {
    if (obj.isString()) {
        const std::string& _res = obj.asString();
        sscanf(_res.c_str(), "%u", &o);
    }
...
static void parse_VkPhysicalDeviceDiscardRectanglePropertiesEXT(const Json::Value& obj, VkPhysicalDeviceDiscardRectanglePropertiesEXT& o) {
...
static void parse_VkPipelineDiscardRectangleStateCreateInfoEXT(const Json::Value& obj, VkPipelineDiscardRectangleStateCreateInfoEXT& o) {
...
static void parse_VkPipelineRasterizationConservativeStateCreateFlagsEXT(const Json::Value& obj, VkPipelineRasterizationConservativeStateCreateFlagsEXT& o) {
    if (obj.isString()) {
        const std::string& _res = obj.asString();
        sscanf(_res.c_str(), "%u", &o);
    }
...
static void parse_VkPhysicalDeviceConservativeRasterizationPropertiesEXT(const Json::Value& obj, VkPhysicalDeviceConservativeRasterizationPropertiesEXT& o) {
...
static void parse_VkPipelineRasterizationConservativeStateCreateInfoEXT(const Json::Value& obj, VkPipelineRasterizationConservativeStateCreateInfoEXT& o) {
...
static void parse_VkPipelineRasterizationDepthClipStateCreateFlagsEXT(const Json::Value& obj, VkPipelineRasterizationDepthClipStateCreateFlagsEXT& o) {
    if (obj.isString()) {
        const std::string& _res = obj.asString();
        sscanf(_res.c_str(), "%u", &o);
    }
...
static void parse_VkPhysicalDeviceDepthClipEnableFeaturesEXT(const Json::Value& obj, VkPhysicalDeviceDepthClipEnableFeaturesEXT& o) {
...
static void parse_VkPipelineRasterizationDepthClipStateCreateInfoEXT(const Json::Value& obj, VkPipelineRasterizationDepthClipStateCreateInfoEXT& o) {
...
static void parse_VkDebugUtilsMessageSeverityFlagBitsEXT(const Json::Value& obj, VkDebugUtilsMessageSeverityFlagBitsEXT& o) {
    const std::string& _res = obj.asString();
...
static void parse_VkDebugUtilsMessengerCallbackDataFlagsEXT(const Json::Value& obj, VkDebugUtilsMessengerCallbackDataFlagsEXT& o) {
    if (obj.isString()) {
        const std::string& _res = obj.asString();
        sscanf(_res.c_str(), "%u", &o);
    }
...
static void parse_VkDebugUtilsMessengerCallbackDataEXT(const Json::Value& obj, VkDebugUtilsMessengerCallbackDataEXT& o) {
    ...
    if (obj_pObjects.size() == 0) (o.pObjects) = nullptr;
        ...
        for (unsigned int i = 0; i < (o.objectCount); i++) {
            parse_VkDebugUtilsObjectNameInfoEXT(obj_pObjects[i], const_cast<VkDebugUtilsObjectNameInfoEXT&>((o.pObjects[i])));
        }
    }
...
static void parse_VkSampleLocationsInfoEXT(const Json::Value& obj, VkSampleLocationsInfoEXT& o) {
    ...
    if (obj_pSampleLocations.size() == 0) (o.pSampleLocations) = nullptr;
        ...
        for (unsigned int i = 0; i < (o.sampleLocationsCount); i++) {
            parse_VkSampleLocationEXT(obj_pSampleLocations[i], const_cast<VkSampleLocationEXT&>((o.pSampleLocations[i])));
        }
    }
...
static void parse_VkRenderPassSampleLocationsBeginInfoEXT(const Json::Value& obj, VkRenderPassSampleLocationsBeginInfoEXT& o) {
    ...
    if (obj_pAttachmentInitialSampleLocations.size() == 0) (o.pAttachmentInitialSampleLocations) = nullptr;
        ...
        for (unsigned int i = 0; i < (o.attachmentInitialSampleLocationsCount); i++) {
            parse_VkAttachmentSampleLocationsEXT(obj_pAttachmentInitialSampleLocations[i], const_cast<VkAttachmentSampleLocationsEXT&>((o.pAttachmentInitialSampleLocations[i])));
        }
    }
    ...
    if (obj_pPostSubpassSampleLocations.size() == 0) (o.pPostSubpassSampleLocations) = nullptr;
        ...
        for (unsigned int i = 0; i < (o.postSubpassSampleLocationsCount); i++) {
            parse_VkSubpassSampleLocationsEXT(obj_pPostSubpassSampleLocations[i], const_cast<VkSubpassSampleLocationsEXT&>((o.pPostSubpassSampleLocations[i])));
        }
    }

}

static void parse_VkPipelineSampleLocationsStateCreateInfoEXT(const Json::Value& obj, VkPipelineSampleLocationsStateCreateInfoEXT& o) {
...
static void parse_VkPhysicalDeviceSampleLocationsPropertiesEXT(const Json::Value& obj, VkPhysicalDeviceSampleLocationsPropertiesEXT& o) {
...
static void parse_VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT(const Json::Value& obj, VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT& o) {
...
static void parse_VkPhysicalDeviceBlendOperationAdvancedPropertiesEXT(const Json::Value& obj, VkPhysicalDeviceBlendOperationAdvancedPropertiesEXT& o) {
...
static void parse_VkPipelineColorBlendAdvancedStateCreateInfoEXT(const Json::Value& obj, VkPipelineColorBlendAdvancedStateCreateInfoEXT& o) {
...
static std::map<std::string, uint64_t> VkFormatFeatureFlagBits2_map = {
    ...
    std::make_pair("VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_FORCEABLE_BIT", 1ULL << 21),
    ...
    std::make_pair("VK_FORMAT_FEATURE_2_HOST_IMAGE_TRANSFER_BIT", 1ULL << 46),
    ...
    std::make_pair("VK_FORMAT_FEATURE_2_ACCELERATION_STRUCTURE_RADIUS_BUFFER_BIT_NV", 1ULL << 51),
    ...
    std::make_pair("VK_FORMAT_FEATURE_2_TENSOR_SHADER_BIT_ARM", 1ULL << 39),
    std::make_pair("VK_FORMAT_FEATURE_2_TENSOR_IMAGE_ALIASING_BIT_ARM", 1ULL << 43),
    ...
    std::make_pair("VK_FORMAT_FEATURE_2_TENSOR_DATA_GRAPH_BIT_ARM", 1ULL << 48),
    std::make_pair("VK_FORMAT_FEATURE_2_RESERVED_60_BIT_EXT", 1ULL << 60),
    std::make_pair("VK_FORMAT_FEATURE_2_COPY_IMAGE_INDIRECT_DST_BIT_KHR", 1ULL << 59),
    std::make_pair("VK_FORMAT_FEATURE_2_VIDEO_ENCODE_QUANTIZATION_DELTA_MAP_BIT_KHR", 1ULL << 49),
    std::make_pair("VK_FORMAT_FEATURE_2_VIDEO_ENCODE_EMPHASIS_MAP_BIT_KHR", 1ULL << 50),
    std::make_pair("VK_FORMAT_FEATURE_2_DEPTH_COPY_ON_COMPUTE_QUEUE_BIT_KHR", 1ULL << 52),
    std::make_pair("VK_FORMAT_FEATURE_2_DEPTH_COPY_ON_TRANSFER_QUEUE_BIT_KHR", 1ULL << 53),
    std::make_pair("VK_FORMAT_FEATURE_2_STENCIL_COPY_ON_COMPUTE_QUEUE_BIT_KHR", 1ULL << 54),
    std::make_pair("VK_FORMAT_FEATURE_2_STENCIL_COPY_ON_TRANSFER_QUEUE_BIT_KHR", 1ULL << 55),
    std::make_pair("VK_FORMAT_FEATURE_2_RESERVED_56_BIT_ARM", 1ULL << 56),
    std::make_pair("VK_FORMAT_FEATURE_2_RESERVED_57_BIT_ARM", 1ULL << 57),
    std::make_pair("VK_FORMAT_FEATURE_2_RESERVED_58_BIT_ARM", 1ULL << 58),
...
static void parse_VkDrmFormatModifierPropertiesListEXT(const Json::Value& obj, VkDrmFormatModifierPropertiesListEXT& o) {
    ...
    if (obj_pDrmFormatModifierProperties.size() == 0) (o.pDrmFormatModifierProperties) = nullptr;
        ...
        for (unsigned int i = 0; i < (o.drmFormatModifierCount); i++) {
            parse_VkDrmFormatModifierPropertiesEXT(obj_pDrmFormatModifierProperties[i], const_cast<VkDrmFormatModifierPropertiesEXT&>((o.pDrmFormatModifierProperties[i])));
        }
    }

}

static void parse_VkPhysicalDeviceImageDrmFormatModifierInfoEXT(const Json::Value& obj, VkPhysicalDeviceImageDrmFormatModifierInfoEXT& o) {
...
static void parse_VkImageDrmFormatModifierListCreateInfoEXT(const Json::Value& obj, VkImageDrmFormatModifierListCreateInfoEXT& o) {
...
static void parse_VkImageDrmFormatModifierExplicitCreateInfoEXT(const Json::Value& obj, VkImageDrmFormatModifierExplicitCreateInfoEXT& o) {
...
static void parse_VkImageDrmFormatModifierPropertiesEXT(const Json::Value& obj, VkImageDrmFormatModifierPropertiesEXT& o) {
...
static void parse_VkDrmFormatModifierPropertiesList2EXT(const Json::Value& obj, VkDrmFormatModifierPropertiesList2EXT& o) {
    ...
    if (obj_pDrmFormatModifierProperties.size() == 0) (o.pDrmFormatModifierProperties) = nullptr;
        ...
        for (unsigned int i = 0; i < (o.drmFormatModifierCount); i++) {
            parse_VkDrmFormatModifierProperties2EXT(obj_pDrmFormatModifierProperties[i], const_cast<VkDrmFormatModifierProperties2EXT&>((o.pDrmFormatModifierProperties[i])));
        }
    }

}

static void parse_VkPhysicalDeviceImageViewImageFormatInfoEXT(const Json::Value& obj, VkPhysicalDeviceImageViewImageFormatInfoEXT& o) {
...
static void parse_VkFilterCubicImageViewImageFormatPropertiesEXT(const Json::Value& obj, VkFilterCubicImageViewImageFormatPropertiesEXT& o) {
...
static void parse_VkPhysicalDeviceExternalMemoryHostPropertiesEXT(const Json::Value& obj, VkPhysicalDeviceExternalMemoryHostPropertiesEXT& o) {
...
static void parse_VkPhysicalDevicePCIBusInfoPropertiesEXT(const Json::Value& obj, VkPhysicalDevicePCIBusInfoPropertiesEXT& o) {
...
static void parse_VkPhysicalDeviceSubgroupSizeControlFeatures(const Json::Value& obj, VkPhysicalDeviceSubgroupSizeControlFeatures& o) {
...
static void parse_VkPhysicalDeviceSubgroupSizeControlProperties(const Json::Value& obj, VkPhysicalDeviceSubgroupSizeControlProperties& o) {
...
static void parse_VkPipelineShaderStageRequiredSubgroupSizeCreateInfo(const Json::Value& obj, VkPipelineShaderStageRequiredSubgroupSizeCreateInfo& o) {
...
static void parse_VkPhysicalDeviceShaderImageAtomicInt64FeaturesEXT(const Json::Value& obj, VkPhysicalDeviceShaderImageAtomicInt64FeaturesEXT& o) {
...
static void parse_VkPhysicalDeviceMemoryBudgetPropertiesEXT(const Json::Value& obj, VkPhysicalDeviceMemoryBudgetPropertiesEXT& o) {
...
static void parse_VkValidationFeaturesEXT(const Json::Value& obj, VkValidationFeaturesEXT& o) {
    ...
    for (unsigned int i = 0; i < obj_pEnabledValidationFeatures_arr.size(); i++) {
        parse_VkValidationFeatureEnableEXT(obj_pEnabledValidationFeatures_arr[i], const_cast<VkValidationFeatureEnableEXT&>((o.pEnabledValidationFeatures[i])));
    }
    ...
    for (unsigned int i = 0; i < obj_pDisabledValidationFeatures_arr.size(); i++) {
        parse_VkValidationFeatureDisableEXT(obj_pDisabledValidationFeatures_arr[i], const_cast<VkValidationFeatureDisableEXT&>((o.pDisabledValidationFeatures[i])));
    }

}

static void parse_VkPhysicalDeviceFragmentShaderInterlockFeaturesEXT(const Json::Value& obj, VkPhysicalDeviceFragmentShaderInterlockFeaturesEXT& o) {
...
static void parse_VkPhysicalDeviceYcbcrImageArraysFeaturesEXT(const Json::Value& obj, VkPhysicalDeviceYcbcrImageArraysFeaturesEXT& o) {
...
static void parse_VkPhysicalDeviceShaderAtomicFloatFeaturesEXT(const Json::Value& obj, VkPhysicalDeviceShaderAtomicFloatFeaturesEXT& o) {
...
static void parse_VkPhysicalDeviceExtendedDynamicStateFeaturesEXT(const Json::Value& obj, VkPhysicalDeviceExtendedDynamicStateFeaturesEXT& o) {
...
static void parse_VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures(const Json::Value& obj, VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures& o) {
...
static void parse_VkPhysicalDeviceTexelBufferAlignmentFeaturesEXT(const Json::Value& obj, VkPhysicalDeviceTexelBufferAlignmentFeaturesEXT& o) {
...
static void parse_VkPhysicalDeviceTexelBufferAlignmentProperties(const Json::Value& obj, VkPhysicalDeviceTexelBufferAlignmentProperties& o) {
    ...
    parse_VkBool32(obj["storageTexelBufferOffsetSingleTexelAlignment"], (o.storageTexelBufferOffsetSingleTexelAlignment));

    parse_VkDeviceSize(obj["uniformTexelBufferOffsetAlignmentBytes"], (o.uniformTexelBufferOffsetAlignmentBytes));

    parse_VkBool32(obj["uniformTexelBufferOffsetSingleTexelAlignment"], (o.uniformTexelBufferOffsetSingleTexelAlignment));

}

static void parse_VkPhysicalDeviceRobustness2FeaturesKHR(const Json::Value& obj, VkPhysicalDeviceRobustness2FeaturesKHR& o) {

    parse_VkStructureType(obj["sType"], (o.sType));

    o.pNext = (VkPhysicalDeviceRobustness2FeaturesKHR*)parsePNextChain(obj);
...
static void parse_VkPhysicalDeviceRobustness2PropertiesKHR(const Json::Value& obj, VkPhysicalDeviceRobustness2PropertiesKHR& o) {

    parse_VkStructureType(obj["sType"], (o.sType));

    o.pNext = (VkPhysicalDeviceRobustness2PropertiesKHR*)parsePNextChain(obj);
...
static void parse_VkSamplerCustomBorderColorCreateInfoEXT(const Json::Value& obj, VkSamplerCustomBorderColorCreateInfoEXT& o) {
...
static void parse_VkPhysicalDeviceCustomBorderColorPropertiesEXT(const Json::Value& obj, VkPhysicalDeviceCustomBorderColorPropertiesEXT& o) {
...
static void parse_VkPhysicalDeviceCustomBorderColorFeaturesEXT(const Json::Value& obj, VkPhysicalDeviceCustomBorderColorFeaturesEXT& o) {
...
static void parse_VkPhysicalDeviceYcbcr2Plane444FormatsFeaturesEXT(const Json::Value& obj, VkPhysicalDeviceYcbcr2Plane444FormatsFeaturesEXT& o) {
...
static void parse_VkPhysicalDeviceImageRobustnessFeatures(const Json::Value& obj, VkPhysicalDeviceImageRobustnessFeatures& o) {
...
static void parse_VkPhysicalDevice4444FormatsFeaturesEXT(const Json::Value& obj, VkPhysicalDevice4444FormatsFeaturesEXT& o) {
...
static void parse_VkPhysicalDeviceVertexInputDynamicStateFeaturesEXT(const Json::Value& obj, VkPhysicalDeviceVertexInputDynamicStateFeaturesEXT& o) {
...
static void parse_VkVertexInputAttributeDescription2EXT(const Json::Value& obj, VkVertexInputAttributeDescription2EXT& o) {
...
static void parse_VkPhysicalDeviceExternalSciSyncFeaturesNV(const Json::Value& obj, VkPhysicalDeviceExternalSciSyncFeaturesNV& o) {
...
static void parse_VkPhysicalDeviceExternalMemorySciBufFeaturesNV(const Json::Value& obj, VkPhysicalDeviceExternalMemorySciBufFeaturesNV& o) {
...
static void parse_VkPhysicalDeviceExtendedDynamicState2FeaturesEXT(const Json::Value& obj, VkPhysicalDeviceExtendedDynamicState2FeaturesEXT& o) {
...
static void parse_VkPhysicalDeviceColorWriteEnableFeaturesEXT(const Json::Value& obj, VkPhysicalDeviceColorWriteEnableFeaturesEXT& o) {
...
static void parse_VkPhysicalDeviceExternalSciSync2FeaturesNV(const Json::Value& obj, VkPhysicalDeviceExternalSciSync2FeaturesNV& o) {
...
static void parse_VkDeviceSemaphoreSciSyncPoolReservationCreateInfoNV(const Json::Value& obj, VkDeviceSemaphoreSciSyncPoolReservationCreateInfoNV& o) {
...
static std::map<std::string, int> VkLayerSettingTypeEXT_map = {
    std::make_pair("0", 0),
    std::make_pair("VK_LAYER_SETTING_TYPE_BOOL32_EXT", 0),
    std::make_pair("VK_LAYER_SETTING_TYPE_INT32_EXT", 1),
    std::make_pair("VK_LAYER_SETTING_TYPE_INT64_EXT", 2),
    std::make_pair("VK_LAYER_SETTING_TYPE_UINT32_EXT", 3),
    std::make_pair("VK_LAYER_SETTING_TYPE_UINT64_EXT", 4),
    std::make_pair("VK_LAYER_SETTING_TYPE_FLOAT32_EXT", 5),
    std::make_pair("VK_LAYER_SETTING_TYPE_FLOAT64_EXT", 6),
    std::make_pair("VK_LAYER_SETTING_TYPE_STRING_EXT", 7),
};
static void parse_VkLayerSettingTypeEXT(const Json::Value& obj, VkLayerSettingTypeEXT& o) {
    const std::string& _res = obj.asString();
    o = (VkLayerSettingTypeEXT)VkLayerSettingTypeEXT_map[std::string(_res)];
}

static void parse_VkLayerSettingEXT(const Json::Value& obj, VkLayerSettingEXT& o) {

    /** TODO: Handle this - pLayerName **/

    /** TODO: Handle this - pSettingName **/

    parse_VkLayerSettingTypeEXT(obj["type"], (o.type));
...
static void parse_VkLayerSettingsCreateInfoEXT(const Json::Value& obj, VkLayerSettingsCreateInfoEXT& o) {
    ...
    o.pNext = (VkLayerSettingsCreateInfoEXT*)parsePNextChain(obj);

    parse_uint32_t(obj["settingCount"], (o.settingCount));

    (o.pSettings) = (VkLayerSettingEXT*)s_globalMem.allocate((o.settingCount), sizeof(VkLayerSettingEXT));
    const Json::Value& obj_pSettings = obj["pSettings"];
    if (obj_pSettings.size() == 0) (o.pSettings) = nullptr;
    else {
        for (unsigned int i = 0; i < (o.settingCount); i++) {
            parse_VkLayerSettingEXT(obj_pSettings[i], const_cast<VkLayerSettingEXT&>((o.pSettings[i])));
        }
    }
...
static void parse_VkPhysicalDeviceExternalMemoryScreenBufferFeaturesQNX(const Json::Value& obj, VkPhysicalDeviceExternalMemoryScreenBufferFeaturesQNX& o) {
...
static void* parsePNextChain(const Json::Value& obj) {
    ...
    switch (o.sType) {
        ...
        case VK_STRUCTURE_TYPE_DEVICE_QUEUE_GLOBAL_PRIORITY_CREATE_INFO:
            p = s_globalMem.allocate(sizeof(VkDeviceQueueGlobalPriorityCreateInfo));
            parse_VkDeviceQueueGlobalPriorityCreateInfo(pNextObj, *((VkDeviceQueueGlobalPriorityCreateInfo*)p));
            break;

        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_GLOBAL_PRIORITY_QUERY_FEATURES:
            p = s_globalMem.allocate(sizeof(VkPhysicalDeviceGlobalPriorityQueryFeatures));
            parse_VkPhysicalDeviceGlobalPriorityQueryFeatures(pNextObj, *((VkPhysicalDeviceGlobalPriorityQueryFeatures*)p));
            break;

        case VK_STRUCTURE_TYPE_QUEUE_FAMILY_GLOBAL_PRIORITY_PROPERTIES:
            p = s_globalMem.allocate(sizeof(VkQueueFamilyGlobalPriorityProperties));
            parse_VkQueueFamilyGlobalPriorityProperties(pNextObj, *((VkQueueFamilyGlobalPriorityProperties*)p));
            break;

        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_TERMINATE_INVOCATION_FEATURES:
            p = s_globalMem.allocate(sizeof(VkPhysicalDeviceShaderTerminateInvocationFeatures));
            parse_VkPhysicalDeviceShaderTerminateInvocationFeatures(pNextObj, *((VkPhysicalDeviceShaderTerminateInvocationFeatures*)p));
            break;
        ...
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_PROPERTIES:
            p = s_globalMem.allocate(sizeof(VkPhysicalDeviceVertexAttributeDivisorProperties));
            parse_VkPhysicalDeviceVertexAttributeDivisorProperties(pNextObj, *((VkPhysicalDeviceVertexAttributeDivisorProperties*)p));
            break;

        case VK_STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_DIVISOR_STATE_CREATE_INFO:
            p = s_globalMem.allocate(sizeof(VkPipelineVertexInputDivisorStateCreateInfo));
            parse_VkPipelineVertexInputDivisorStateCreateInfo(pNextObj, *((VkPipelineVertexInputDivisorStateCreateInfo*)p));
            break;

        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_FEATURES:
            p = s_globalMem.allocate(sizeof(VkPhysicalDeviceVertexAttributeDivisorFeatures));
            parse_VkPhysicalDeviceVertexAttributeDivisorFeatures(pNextObj, *((VkPhysicalDeviceVertexAttributeDivisorFeatures*)p));
            break;

        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_INDEX_TYPE_UINT8_FEATURES:
            p = s_globalMem.allocate(sizeof(VkPhysicalDeviceIndexTypeUint8Features));
            parse_VkPhysicalDeviceIndexTypeUint8Features(pNextObj, *((VkPhysicalDeviceIndexTypeUint8Features*)p));
            break;

        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LINE_RASTERIZATION_FEATURES:
            p = s_globalMem.allocate(sizeof(VkPhysicalDeviceLineRasterizationFeatures));
            parse_VkPhysicalDeviceLineRasterizationFeatures(pNextObj, *((VkPhysicalDeviceLineRasterizationFeatures*)p));
            break;

        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LINE_RASTERIZATION_PROPERTIES:
            p = s_globalMem.allocate(sizeof(VkPhysicalDeviceLineRasterizationProperties));
            parse_VkPhysicalDeviceLineRasterizationProperties(pNextObj, *((VkPhysicalDeviceLineRasterizationProperties*)p));
            break;

        case VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_LINE_STATE_CREATE_INFO:
            p = s_globalMem.allocate(sizeof(VkPipelineRasterizationLineStateCreateInfo));
            parse_VkPipelineRasterizationLineStateCreateInfo(pNextObj, *((VkPipelineRasterizationLineStateCreateInfo*)p));
            break;

        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TEXTURE_COMPRESSION_ASTC_HDR_FEATURES:
            p = s_globalMem.allocate(sizeof(VkPhysicalDeviceTextureCompressionASTCHDRFeatures));
            parse_VkPhysicalDeviceTextureCompressionASTCHDRFeatures(pNextObj, *((VkPhysicalDeviceTextureCompressionASTCHDRFeatures*)p));
            break;
        ...
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SUBGROUP_SIZE_CONTROL_FEATURES:
            ...
            parse_VkPhysicalDeviceSubgroupSizeControlFeatures(pNextObj, *((VkPhysicalDeviceSubgroupSizeControlFeatures*)p));
            break;

        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SUBGROUP_SIZE_CONTROL_PROPERTIES:
            p = s_globalMem.allocate(sizeof(VkPhysicalDeviceSubgroupSizeControlProperties));
            parse_VkPhysicalDeviceSubgroupSizeControlProperties(pNextObj, *((VkPhysicalDeviceSubgroupSizeControlProperties*)p));
            break;

        case VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_REQUIRED_SUBGROUP_SIZE_CREATE_INFO:
            p = s_globalMem.allocate(sizeof(VkPipelineShaderStageRequiredSubgroupSizeCreateInfo));
            parse_VkPipelineShaderStageRequiredSubgroupSizeCreateInfo(pNextObj, *((VkPipelineShaderStageRequiredSubgroupSizeCreateInfo*)p));
            break;
        ...
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_DEMOTE_TO_HELPER_INVOCATION_FEATURES:
            ...
            parse_VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures(pNextObj, *((VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures*)p));
            break;
        ...
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TEXEL_BUFFER_ALIGNMENT_PROPERTIES:
            ...
            parse_VkPhysicalDeviceTexelBufferAlignmentProperties(pNextObj, *((VkPhysicalDeviceTexelBufferAlignmentProperties*)p));
            break;

        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ROBUSTNESS_2_FEATURES_KHR:
            p = s_globalMem.allocate(sizeof(VkPhysicalDeviceRobustness2FeaturesKHR));
            parse_VkPhysicalDeviceRobustness2FeaturesKHR(pNextObj, *((VkPhysicalDeviceRobustness2FeaturesKHR*)p));
            break;

        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ROBUSTNESS_2_PROPERTIES_KHR:
            p = s_globalMem.allocate(sizeof(VkPhysicalDeviceRobustness2PropertiesKHR));
            parse_VkPhysicalDeviceRobustness2PropertiesKHR(pNextObj, *((VkPhysicalDeviceRobustness2PropertiesKHR*)p));
            break;
        ...
        case VK_STRUCTURE_TYPE_LAYER_SETTINGS_CREATE_INFO_EXT:
            p = s_globalMem.allocate(sizeof(VkLayerSettingsCreateInfoEXT));
            parse_VkLayerSettingsCreateInfoEXT(pNextObj, *((VkLayerSettingsCreateInfoEXT*)p));
            break;
        ...
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_MEMORY_SCREEN_BUFFER_FEATURES_QNX:
            ...
            parse_VkPhysicalDeviceExternalMemoryScreenBufferFeaturesQNX(pNextObj, *((VkPhysicalDeviceExternalMemoryScreenBufferFeaturesQNX*)p));
            break;
